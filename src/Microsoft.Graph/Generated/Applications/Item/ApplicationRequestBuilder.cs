...
using MicrosoftGraph.Applications.Item.AddKey;
using MicrosoftGraph.Applications.Item.AddPassword;
using MicrosoftGraph.Applications.Item.CheckMemberGroups;
using MicrosoftGraph.Applications.Item.CheckMemberObjects;
using MicrosoftGraph.Applications.Item.CreatedOnBehalfOf;
using MicrosoftGraph.Applications.Item.ExtensionProperties;
using MicrosoftGraph.Applications.Item.GetMemberGroups;
using MicrosoftGraph.Applications.Item.GetMemberObjects;
using MicrosoftGraph.Applications.Item.HomeRealmDiscoveryPolicies;
using MicrosoftGraph.Applications.Item.Logo;
using MicrosoftGraph.Applications.Item.Owners;
using MicrosoftGraph.Applications.Item.RemoveKey;
using MicrosoftGraph.Applications.Item.RemovePassword;
using MicrosoftGraph.Applications.Item.Restore;
using MicrosoftGraph.Applications.Item.SetVerifiedPublisher;
using MicrosoftGraph.Applications.Item.TokenIssuancePolicies;
using MicrosoftGraph.Applications.Item.TokenLifetimePolicies;
using MicrosoftGraph.Applications.Item.UnsetVerifiedPublisher;
...
namespace MicrosoftGraph.Applications.Item {
    ...
    public class ApplicationRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraph.Models.Microsoft.Graph.Application body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraph.Models.Microsoft.Graph.Application> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraph.Models.Microsoft.Graph.Application body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
