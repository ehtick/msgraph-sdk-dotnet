...
namespace MicrosoftGraph.Applications.GetAvailableExtensionProperties {
    /// <summary>Builds and executes requests for operations under \applications\microsoft.graph.getAvailableExtensionProperties</summary>
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public GetAvailableExtensionPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/microsoft.graph.getAvailableExtensionProperties";
