...
using MicrosoftGraph.Communications.Calls.Item.Answer;
using MicrosoftGraph.Communications.Calls.Item.AudioRoutingGroups;
using MicrosoftGraph.Communications.Calls.Item.CancelMediaProcessing;
using MicrosoftGraph.Communications.Calls.Item.ChangeScreenSharingRole;
using MicrosoftGraph.Communications.Calls.Item.KeepAlive;
using MicrosoftGraph.Communications.Calls.Item.Mute;
using MicrosoftGraph.Communications.Calls.Item.Operations;
using MicrosoftGraph.Communications.Calls.Item.Participants;
using MicrosoftGraph.Communications.Calls.Item.PlayPrompt;
using MicrosoftGraph.Communications.Calls.Item.RecordResponse;
using MicrosoftGraph.Communications.Calls.Item.Redirect;
using MicrosoftGraph.Communications.Calls.Item.Reject;
using MicrosoftGraph.Communications.Calls.Item.SubscribeToTone;
using MicrosoftGraph.Communications.Calls.Item.Transfer;
using MicrosoftGraph.Communications.Calls.Item.Unmute;
using MicrosoftGraph.Communications.Calls.Item.UpdateRecordingStatus;
...
namespace MicrosoftGraph.Communications.Calls.Item {
