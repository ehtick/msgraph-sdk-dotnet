...
using MicrosoftGraph.Communications.OnlineMeetings.Item.AttendanceReports;
using MicrosoftGraph.Communications.OnlineMeetings.Item.AttendeeReport;
...
namespace MicrosoftGraph.Communications.OnlineMeetings.Item {
    ...
    public class OnlineMeetingRequestBuilder {
        ...
        /// </summary>
        public OnlineMeetingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/communications/onlineMeetings/{onlineMeeting_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public OnlineMeetingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(OnlineMeeting body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
