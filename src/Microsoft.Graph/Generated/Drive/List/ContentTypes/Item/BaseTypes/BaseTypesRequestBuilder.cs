...
using MicrosoftGraph.Drive.List.ContentTypes.Item.BaseTypes.AddCopy;
using MicrosoftGraph.Drive.List.ContentTypes.Item.BaseTypes.Ref;
using System;
...
namespace MicrosoftGraph.Drive.List.ContentTypes.Item.BaseTypes {
    /// <summary>Builds and executes requests for operations under \drive\list\contentTypes\{contentType-id}\baseTypes</summary>
    public class BaseTypesRequestBuilder {
        ...
        public BaseTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType_id}/baseTypes{?top,skip,search,filter,count,orderby,select,expand}";
