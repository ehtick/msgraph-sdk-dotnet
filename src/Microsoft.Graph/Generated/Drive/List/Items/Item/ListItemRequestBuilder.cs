...
using MicrosoftGraph.Drive.List.Items.Item.Analytics;
using MicrosoftGraph.Drive.List.Items.Item.DriveItem;
using MicrosoftGraph.Drive.List.Items.Item.Fields;
using MicrosoftGraph.Drive.List.Items.Item.GetActivitiesByInterval;
using MicrosoftGraph.Drive.List.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraph.Drive.List.Items.Item.Versions;
...
namespace MicrosoftGraph.Drive.List.Items.Item {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/items/{listItem_id}{?select,expand}";
