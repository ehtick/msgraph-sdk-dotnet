...
using MicrosoftGraph.Drive.List.Items.Item;
...
namespace MicrosoftGraph.Drive.List.Items {
    /// <summary>Builds and executes requests for operations under \drive\list\items</summary>
    public class ItemsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.drive.list.items.item collection</summary>
        ...
        public ItemsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/items{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
