...
using MicrosoftGraph.Drive.Bundles;
using MicrosoftGraph.Drive.Following;
using MicrosoftGraph.Drive.Items;
using MicrosoftGraph.Drive.List;
using MicrosoftGraph.Drive.Recent;
using MicrosoftGraph.Drive.Root;
using MicrosoftGraph.Drive.SearchWithQ;
using MicrosoftGraph.Drive.SharedWithMe;
using MicrosoftGraph.Drive.Special;
...
namespace MicrosoftGraph.Drive {
    ...
    public class DriveRequestBuilder {
        ...
        public DriveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive{?select,expand}";
