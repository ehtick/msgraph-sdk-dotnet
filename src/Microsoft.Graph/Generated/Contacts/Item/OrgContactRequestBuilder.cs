...
using MicrosoftGraph.Contacts.Item.CheckMemberGroups;
using MicrosoftGraph.Contacts.Item.CheckMemberObjects;
using MicrosoftGraph.Contacts.Item.DirectReports;
using MicrosoftGraph.Contacts.Item.GetMemberGroups;
using MicrosoftGraph.Contacts.Item.GetMemberObjects;
using MicrosoftGraph.Contacts.Item.Manager;
using MicrosoftGraph.Contacts.Item.MemberOf;
using MicrosoftGraph.Contacts.Item.Restore;
using MicrosoftGraph.Contacts.Item.TransitiveMemberOf;
...
namespace MicrosoftGraph.Contacts.Item {
    ...
    public class OrgContactRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public OrgContactRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
