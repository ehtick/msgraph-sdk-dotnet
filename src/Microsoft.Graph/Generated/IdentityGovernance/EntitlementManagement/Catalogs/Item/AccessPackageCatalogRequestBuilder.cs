...
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages;
...
namespace MicrosoftGraph.IdentityGovernance.EntitlementManagement.Catalogs.Item {
    /// <summary>Builds and executes requests for operations under \identityGovernance\entitlementManagement\catalogs\{accessPackageCatalog-id}</summary>
    public class AccessPackageCatalogRequestBuilder {
        ...
        /// </summary>
        public AccessPackageCatalogRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AccessPackageCatalogRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(AccessPackageCatalog body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
