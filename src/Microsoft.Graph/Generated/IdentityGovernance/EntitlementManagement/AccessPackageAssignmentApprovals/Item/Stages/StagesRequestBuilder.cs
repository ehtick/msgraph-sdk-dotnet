...
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals.Item.Stages.Item;
...
namespace MicrosoftGraph.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals.Item.Stages {
    /// <summary>Builds and executes requests for operations under \identityGovernance\entitlementManagement\accessPackageAssignmentApprovals\{approval-id}\stages</summary>
    public class StagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.identityGovernance.entitlementManagement.accessPackageAssignmentApprovals.item.stages.item collection</summary>
        ...
        public StagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval_id}/stages{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public StagesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
