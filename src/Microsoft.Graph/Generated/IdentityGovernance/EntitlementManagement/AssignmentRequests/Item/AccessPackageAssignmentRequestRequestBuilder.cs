...
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.AccessPackage;
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Assignment;
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Cancel;
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Requestor;
...
namespace MicrosoftGraph.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item {
    ...
    public class AccessPackageAssignmentRequestRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AccessPackageAssignmentRequestRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AccessPackageAssignmentRequest body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
