...
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Requestor.Ref;
...
namespace MicrosoftGraph.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Requestor {
    ...
    public class RequestorRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public RequestorRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
