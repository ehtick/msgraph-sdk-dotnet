...
namespace MicrosoftGraph.IdentityGovernance.EntitlementManagement.AssignmentRequests {
    public class AssignmentRequestsResponse : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as AssignmentRequestsResponse).Value = n.GetCollectionOfObjectValues<AccessPackageAssignmentRequest>().ToList(); } },
            };
        }
        /// <summary>
