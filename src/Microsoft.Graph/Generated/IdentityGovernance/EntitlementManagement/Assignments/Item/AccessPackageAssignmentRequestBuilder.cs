...
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.Assignments.Item.AccessPackage;
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.Assignments.Item.Target;
...
namespace MicrosoftGraph.IdentityGovernance.EntitlementManagement.Assignments.Item {
    ...
    public class AccessPackageAssignmentRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AccessPackageAssignmentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AccessPackageAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
