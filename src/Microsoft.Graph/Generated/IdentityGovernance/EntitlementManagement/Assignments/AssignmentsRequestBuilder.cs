...
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.Assignments.FilterByCurrentUserWithOn;
using MicrosoftGraph.IdentityGovernance.EntitlementManagement.Assignments.Item;
...
namespace MicrosoftGraph.IdentityGovernance.EntitlementManagement.Assignments {
    /// <summary>Builds and executes requests for operations under \identityGovernance\entitlementManagement\assignments</summary>
    public class AssignmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.identityGovernance.entitlementManagement.assignments.item collection</summary>
        public AccessPackageAssignmentRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("accessPackageAssignment_id", position);
            return new AccessPackageAssignmentRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AccessPackageAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
