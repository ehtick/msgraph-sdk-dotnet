...
using MicrosoftGraph.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.Item.Approval.Stages.Item;
...
namespace MicrosoftGraph.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.Item.Approval.Stages {
    ...
    public class StagesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.identityGovernance.appConsent.appConsentRequests.item.userConsentRequests.item.approval.stages.item collection</summary>
