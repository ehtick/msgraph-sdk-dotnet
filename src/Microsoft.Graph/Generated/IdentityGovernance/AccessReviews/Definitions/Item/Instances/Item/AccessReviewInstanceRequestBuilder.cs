...
using MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.AcceptRecommendations;
using MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.ApplyDecisions;
using MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.BatchRecordDecisions;
using MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.ContactedReviewers;
using MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.Decisions;
using MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.ResetDecisions;
using MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.SendReminder;
using MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.Stop;
...
namespace MicrosoftGraph.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item {
