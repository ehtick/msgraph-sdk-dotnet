...
namespace MicrosoftGraph.IdentityGovernance.AccessReviews {
    ...
    public class AccessReviewsRequestBuilder {
        ...
        public AccessReviewsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/accessReviews{?select,expand}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(AccessReviewSet body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
