...
using MicrosoftGraph.Users.Item.Calendar.Events.Item.Accept;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.Attachments;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.Calendar;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.Cancel;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.Decline;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.DismissReminder;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.Extensions;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.Forward;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.Instances;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.SnoozeReminder;
using MicrosoftGraph.Users.Item.Calendar.Events.Item.TentativelyAccept;
using System;
...
namespace MicrosoftGraph.Users.Item.Calendar.Events.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendar\events\{event-id}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendar/events/{event_id}{?select}";
