...
namespace MicrosoftGraph.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.ColumnsAfterWithCount {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\trending\{trending-id}\resource\microsoft.graph.workbookRange\microsoft.graph.columnsAfter(count={count})</summary>
    public class ColumnsAfterWithCountRequestBuilder {
        ...
        public ColumnsAfterWithCountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? count = default) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.workbookRange/microsoft.graph.columnsAfter(count={count})";
