...
namespace MicrosoftGraph.Users.Item.Insights.Trending.Item.Resource.PrintJob.Start {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\trending\{trending-id}\resource\microsoft.graph.printJob\microsoft.graph.start</summary>
    public class StartRequestBuilder {
        ...
        public StartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.printJob/microsoft.graph.start";
