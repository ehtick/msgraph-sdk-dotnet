...
using MicrosoftGraph.Users.Item.Insights.Trending.Item.Resource.ScheduleChangeRequest.Approve;
using MicrosoftGraph.Users.Item.Insights.Trending.Item.Resource.ScheduleChangeRequest.Decline;
using System;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
namespace MicrosoftGraph.Users.Item.Insights.Trending.Item.Resource.ScheduleChangeRequest {
    ...
    public class ScheduleChangeRequestRequestBuilder {
        ...
        public ScheduleChangeRequestRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.scheduleChangeRequest";
