...
namespace MicrosoftGraph.Users.Item.Insights.Trending.Item.Resource.PrintJob.Redirect {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\trending\{trending-id}\resource\microsoft.graph.printJob\microsoft.graph.redirect</summary>
    public class RedirectRequestBuilder {
        ...
        public RedirectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trending_id}/resource/microsoft.graph.printJob/microsoft.graph.redirect";
