...
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.CalendarSharingMessage;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.ManagedAppProtection;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.MobileAppContentFile;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.PrintDocument;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.PrintJob;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.Ref;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.ScheduleChangeRequest;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.TargetedManagedAppProtection;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WindowsInformationProtection;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRangeFill;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRangeFormat;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRangeSort;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRangeView;
using System;
...
namespace MicrosoftGraph.Users.Item.Insights.Used.Item.Resource {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\used\{usedInsight-id}\resource</summary>
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/used/{usedInsight_id}/resource{?select,expand}";
