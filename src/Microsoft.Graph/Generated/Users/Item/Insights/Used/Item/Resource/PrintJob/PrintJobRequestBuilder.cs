...
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.PrintJob.Abort;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.PrintJob.Cancel;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.PrintJob.Redirect;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.PrintJob.Start;
using System;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
namespace MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.PrintJob {
    ...
    public class PrintJobRequestBuilder {
        ...
        public PrintJobRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.printJob";
