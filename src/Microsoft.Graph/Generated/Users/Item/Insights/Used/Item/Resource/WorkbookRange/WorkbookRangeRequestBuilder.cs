...
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.BoundingRectWithAnotherRange;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.CellWithRowWithColumn;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.Clear;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsAfter;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsAfterWithCount;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsBefore;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsBeforeWithCount;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnWithColumn;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.Delete;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.EntireColumn;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.EntireRow;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.Insert;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.IntersectionWithAnotherRange;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.LastCell;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.LastColumn;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.LastRow;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.Merge;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.RowsAbove;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.RowsAboveWithCount;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.RowsBelow;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.RowsBelowWithCount;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.RowWithRow;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.Unmerge;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.UsedRange;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.UsedRangeWithValuesOnly;
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.VisibleView;
using System;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
namespace MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\used\{usedInsight-id}\resource\microsoft.graph.workbookRange</summary>
    public class WorkbookRangeRequestBuilder {
        ...
        public WorkbookRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.workbookRange";
