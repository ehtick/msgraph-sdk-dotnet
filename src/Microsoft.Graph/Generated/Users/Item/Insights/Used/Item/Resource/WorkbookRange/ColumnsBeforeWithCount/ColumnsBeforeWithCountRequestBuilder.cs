...
namespace MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsBeforeWithCount {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\used\{usedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.columnsBefore(count={count})</summary>
    public class ColumnsBeforeWithCountRequestBuilder {
        ...
        public ColumnsBeforeWithCountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? count = default) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.columnsBefore(count={count})";
