...
using MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.CalendarSharingMessage.Accept;
using System;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
namespace MicrosoftGraph.Users.Item.Insights.Used.Item.Resource.CalendarSharingMessage {
    ...
    public class CalendarSharingMessageRequestBuilder {
        ...
        public CalendarSharingMessageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/used/{usedInsight_id}/resource/microsoft.graph.calendarSharingMessage";
