...
namespace MicrosoftGraph.Users.Item.Insights.Shared.Item.Resource.PrintDocument.CreateUploadSession {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\resource\microsoft.graph.printDocument\microsoft.graph.createUploadSession</summary>
    public class CreateUploadSessionRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.printDocument/microsoft.graph.createUploadSession";
