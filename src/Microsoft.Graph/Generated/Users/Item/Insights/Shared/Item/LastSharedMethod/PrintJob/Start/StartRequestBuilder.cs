...
namespace MicrosoftGraph.Users.Item.Insights.Shared.Item.LastSharedMethod.PrintJob.Start {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\lastSharedMethod\microsoft.graph.printJob\microsoft.graph.start</summary>
    public class StartRequestBuilder {
        ...
        public StartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.printJob/microsoft.graph.start";
        ...
        public async Task<StartResponse> PostAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<StartResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
