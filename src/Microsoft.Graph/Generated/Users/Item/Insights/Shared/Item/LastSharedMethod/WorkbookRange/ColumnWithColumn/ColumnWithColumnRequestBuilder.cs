...
namespace MicrosoftGraph.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnWithColumn {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\lastSharedMethod\microsoft.graph.workbookRange\microsoft.graph.column(column={column})</summary>
    public class ColumnWithColumnRequestBuilder {
        ...
        public ColumnWithColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? column = default) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange/microsoft.graph.column(column={column})";
        ...
        public class ColumnWithColumnResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as ColumnWithColumnResponse).WorkbookRange = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WorkbookRange>(); } },
                };
            }
            /// <summary>
