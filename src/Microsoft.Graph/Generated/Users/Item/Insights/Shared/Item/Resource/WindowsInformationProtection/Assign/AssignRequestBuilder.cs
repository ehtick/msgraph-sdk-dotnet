...
namespace MicrosoftGraph.Users.Item.Insights.Shared.Item.Resource.WindowsInformationProtection.Assign {
    ...
    public class AssignRequestBuilder {
        ...
        public AssignRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.windowsInformationProtection/microsoft.graph.assign";
