...
using MicrosoftGraph.Users.Item.Insights.Shared.Item.LastSharedMethod;
using MicrosoftGraph.Users.Item.Insights.Shared.Item.Resource;
using System;
...
namespace MicrosoftGraph.Users.Item.Insights.Shared.Item {
    ...
    public class SharedInsightRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public SharedInsightRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(SharedInsight body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
