...
namespace MicrosoftGraph.Users.Item.Insights.Shared.Item.Resource.PrintJob.Cancel {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\resource\microsoft.graph.printJob\microsoft.graph.cancel</summary>
    public class CancelRequestBuilder {
        ...
        public CancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.printJob/microsoft.graph.cancel";
