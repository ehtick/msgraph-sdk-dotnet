...
namespace MicrosoftGraph.Users.Item.Insights.Shared.Item.Resource.WorkbookRange.VisibleView {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.visibleView()</summary>
    public class VisibleViewRequestBuilder {
        ...
        public VisibleViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.visibleView()";
        ...
        public class VisibleViewResponse : IParsable {
            ...
            public MicrosoftGraph.Models.Microsoft.Graph.WorkbookRangeView WorkbookRangeView { get; set; }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRangeView", (o,n) => { (o as VisibleViewResponse).WorkbookRangeView = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WorkbookRangeView>(); } },
                };
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WorkbookRangeView>("workbookRangeView", WorkbookRangeView);
