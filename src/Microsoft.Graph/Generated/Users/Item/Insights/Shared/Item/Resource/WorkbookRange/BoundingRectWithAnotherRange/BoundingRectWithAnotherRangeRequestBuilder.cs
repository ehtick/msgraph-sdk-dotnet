...
namespace MicrosoftGraph.Users.Item.Insights.Shared.Item.Resource.WorkbookRange.BoundingRectWithAnotherRange {
    ...
    public class BoundingRectWithAnotherRangeRequestBuilder {
        ...
        public BoundingRectWithAnotherRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string anotherRange = default) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.boundingRect(anotherRange='{anotherRange}')";
