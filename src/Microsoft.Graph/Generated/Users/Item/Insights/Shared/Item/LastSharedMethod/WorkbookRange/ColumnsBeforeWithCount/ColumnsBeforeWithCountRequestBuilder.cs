...
namespace MicrosoftGraph.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsBeforeWithCount {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\lastSharedMethod\microsoft.graph.workbookRange\microsoft.graph.columnsBefore(count={count})</summary>
    public class ColumnsBeforeWithCountRequestBuilder {
        ...
        public ColumnsBeforeWithCountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? count = default) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange/microsoft.graph.columnsBefore(count={count})";
        ...
        public async Task<ColumnsBeforeWithCountResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<ColumnsBeforeWithCountResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        ...
        public class ColumnsBeforeWithCountResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as ColumnsBeforeWithCountResponse).WorkbookRange = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WorkbookRange>(); } },
                };
            }
            /// <summary>
