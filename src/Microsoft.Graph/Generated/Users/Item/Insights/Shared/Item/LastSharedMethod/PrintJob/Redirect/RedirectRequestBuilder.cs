...
namespace MicrosoftGraph.Users.Item.Insights.Shared.Item.LastSharedMethod.PrintJob.Redirect {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\shared\{sharedInsight-id}\lastSharedMethod\microsoft.graph.printJob\microsoft.graph.redirect</summary>
    public class RedirectRequestBuilder {
        ...
        /// </summary>
        public RedirectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.printJob/microsoft.graph.redirect";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public RedirectRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public class RedirectResponse : IParsable {
            ...
            public MicrosoftGraph.Models.Microsoft.Graph.PrintJob PrintJob { get; set; }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"printJob", (o,n) => { (o as RedirectResponse).PrintJob = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.PrintJob>(); } },
                };
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.PrintJob>("printJob", PrintJob);
