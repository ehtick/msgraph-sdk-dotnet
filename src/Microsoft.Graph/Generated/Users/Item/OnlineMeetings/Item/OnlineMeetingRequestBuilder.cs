...
using MicrosoftGraph.Users.Item.OnlineMeetings.Item.AttendanceReports;
using MicrosoftGraph.Users.Item.OnlineMeetings.Item.AttendeeReport;
using System;
...
namespace MicrosoftGraph.Users.Item.OnlineMeetings.Item {
    ...
    public class OnlineMeetingRequestBuilder {
        ...
        public OnlineMeetingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/onlineMeetings/{onlineMeeting_id}{?select,expand}";
