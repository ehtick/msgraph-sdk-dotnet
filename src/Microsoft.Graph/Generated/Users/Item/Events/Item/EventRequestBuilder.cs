...
using MicrosoftGraph.Users.Item.Events.Item.Accept;
using MicrosoftGraph.Users.Item.Events.Item.Attachments;
using MicrosoftGraph.Users.Item.Events.Item.Calendar;
using MicrosoftGraph.Users.Item.Events.Item.Cancel;
using MicrosoftGraph.Users.Item.Events.Item.Decline;
using MicrosoftGraph.Users.Item.Events.Item.DismissReminder;
using MicrosoftGraph.Users.Item.Events.Item.Extensions;
using MicrosoftGraph.Users.Item.Events.Item.Forward;
using MicrosoftGraph.Users.Item.Events.Item.Instances;
using MicrosoftGraph.Users.Item.Events.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Users.Item.Events.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Users.Item.Events.Item.SnoozeReminder;
using MicrosoftGraph.Users.Item.Events.Item.TentativelyAccept;
using System;
...
namespace MicrosoftGraph.Users.Item.Events.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\events\{event-id}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/events/{event_id}{?select}";
