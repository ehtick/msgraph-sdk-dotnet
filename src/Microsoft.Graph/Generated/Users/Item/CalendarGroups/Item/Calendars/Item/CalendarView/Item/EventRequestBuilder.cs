...
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Accept;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Calendar;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Cancel;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Decline;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.DismissReminder;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Extensions;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Forward;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.SnoozeReminder;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.TentativelyAccept;
using System;
...
namespace MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\calendarView\{event-id}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/calendarView/{event_id}{?select}";
