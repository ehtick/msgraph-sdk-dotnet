...
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Accept;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Attachments;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Calendar;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Cancel;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Decline;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.DismissReminder;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Extensions;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Forward;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Instances;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.SnoozeReminder;
using MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.TentativelyAccept;
using System;
...
namespace MicrosoftGraph.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/events/{event_id}{?select}";
