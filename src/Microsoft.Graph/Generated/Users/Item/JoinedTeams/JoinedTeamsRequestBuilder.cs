...
using MicrosoftGraph.Users.Item.JoinedTeams.Item;
using System;
...
namespace MicrosoftGraph.Users.Item.JoinedTeams {
    ...
    public class JoinedTeamsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.users.item.joinedTeams.item collection</summary>
        ...
        public JoinedTeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
