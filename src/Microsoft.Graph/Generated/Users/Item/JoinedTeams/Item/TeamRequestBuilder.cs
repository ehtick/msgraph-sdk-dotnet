...
namespace MicrosoftGraph.Users.Item.JoinedTeams.Item {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\joinedTeams\{team-id}</summary>
    public class TeamRequestBuilder {
        ...
        public TeamRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/joinedTeams/{team_id}{?select,expand}";
