...
namespace MicrosoftGraph.Users.GetAvailableExtensionProperties {
    /// <summary>Builds and executes requests for operations under \users\microsoft.graph.getAvailableExtensionProperties</summary>
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public GetAvailableExtensionPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/microsoft.graph.getAvailableExtensionProperties";
