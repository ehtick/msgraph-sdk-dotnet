...
using MicrosoftGraph.Education.Classes.Item.AssignmentCategories.Item;
...
namespace MicrosoftGraph.Education.Classes.Item.AssignmentCategories {
    ...
    public class AssignmentCategoriesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.education.classes.item.assignmentCategories.item collection</summary>
        ...
        /// </summary>
        public AssignmentCategoriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/education/classes/{educationClass_id}/assignmentCategories{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AssignmentCategoriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public async Task<AssignmentCategoriesResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<AssignmentCategoriesResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// Create new navigation property to assignmentCategories for education
        /// <param name="body"></param>
