...
using MicrosoftGraph.Education.Classes.Item.Assignments.Item;
...
namespace MicrosoftGraph.Education.Classes.Item.Assignments {
    /// <summary>Builds and executes requests for operations under \education\classes\{educationClass-id}\assignments</summary>
    public class AssignmentsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.education.classes.item.assignments.item collection</summary>
        ...
        public AssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/education/classes/{educationClass_id}/assignments{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationAssignment> PostAsync(EducationAssignment body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
