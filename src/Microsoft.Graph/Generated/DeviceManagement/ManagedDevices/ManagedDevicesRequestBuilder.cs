...
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item;
...
namespace MicrosoftGraph.DeviceManagement.ManagedDevices {
    ...
    public class ManagedDevicesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.deviceManagement.managedDevices.item collection</summary>
        ...
        public ManagedDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/managedDevices{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ManagedDevice body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
