...
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.BypassActivationLock;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.CleanWindowsDevice;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.DeleteUserFromSharedAppleDevice;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.DeviceCategory;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.DeviceCompliancePolicyStates;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.DeviceConfigurationStates;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.DisableLostMode;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.LocateDevice;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.LogoutSharedAppleDeviceActiveUser;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.RebootNow;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.RecoverPasscode;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.RemoteLock;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.RequestRemoteAssistance;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.ResetPasscode;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.Retire;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.ShutDown;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.SyncDevice;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.UpdateWindowsDeviceAccount;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.WindowsDefenderScan;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.WindowsDefenderUpdateSignatures;
using MicrosoftGraph.DeviceManagement.ManagedDevices.Item.Wipe;
...
namespace MicrosoftGraph.DeviceManagement.ManagedDevices.Item {
