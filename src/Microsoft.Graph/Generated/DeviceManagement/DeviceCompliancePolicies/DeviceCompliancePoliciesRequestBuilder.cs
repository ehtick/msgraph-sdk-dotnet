...
namespace MicrosoftGraph.DeviceManagement.DeviceCompliancePolicies {
    ...
    public class DeviceCompliancePoliciesRequestBuilder {
        ...
        public DeviceCompliancePoliciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/deviceCompliancePolicies{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DeviceCompliancePolicy body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        public async Task<DeviceCompliancePoliciesResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceCompliancePoliciesResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// The device compliance policies.
        /// <param name="body"></param>
        ...
        public async Task<DeviceCompliancePolicy> PostAsync(DeviceCompliancePolicy body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<DeviceCompliancePolicy>(requestInfo, responseHandler, default, cancellationToken);
        }
