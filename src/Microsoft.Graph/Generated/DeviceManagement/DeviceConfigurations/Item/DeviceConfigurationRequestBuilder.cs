...
using MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item.Assign;
using MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item.Assignments;
using MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item.DeviceSettingStateSummaries;
using MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item.DeviceStatuses;
using MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item.DeviceStatusOverview;
using MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item.GetOmaSettingPlainTextValueWithSecretReferenceValueId;
using MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item.UserStatuses;
using MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item.UserStatusOverview;
...
namespace MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item {
    ...
    public class DeviceConfigurationRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DeviceConfiguration body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
