...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.DeviceManagement.DeviceConfigurations.Item.Assign {
    public class AssignRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"assignments", (o,n) => { (o as AssignRequestBody).Assignments = n.GetCollectionOfObjectValues<DeviceConfigurationAssignment>().ToList(); } },
            };
        }
        /// <summary>
