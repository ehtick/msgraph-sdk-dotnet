...
namespace MicrosoftGraph.DeviceManagement.GetEffectivePermissionsWithScope {
    ...
    public class GetEffectivePermissionsWithScopeRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<MicrosoftGraph.DeviceManagement.GetEffectivePermissionsWithScope.GetEffectivePermissionsWithScope>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<MicrosoftGraph.DeviceManagement.GetEffectivePermissionsWithScope.GetEffectivePermissionsWithScope>(requestInfo, responseHandler, default, cancellationToken);
        }
    }
}
