...
using MicrosoftGraph.IdentityProtection.RiskyUsers.Item.History.Item;
...
namespace MicrosoftGraph.IdentityProtection.RiskyUsers.Item.History {
    /// <summary>Builds and executes requests for operations under \identityProtection\riskyUsers\{riskyUser-id}\history</summary>
    public class HistoryRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.identityProtection.riskyUsers.item.history.item collection</summary>
        ...
        public HistoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityProtection/riskyUsers/{riskyUser_id}/history{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RiskyUserHistoryItem body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
