...
using MicrosoftGraph.IdentityProtection.RiskyUsers.ConfirmCompromised;
using MicrosoftGraph.IdentityProtection.RiskyUsers.Dismiss;
using MicrosoftGraph.IdentityProtection.RiskyUsers.Item;
...
namespace MicrosoftGraph.IdentityProtection.RiskyUsers {
    /// <summary>Builds and executes requests for operations under \identityProtection\riskyUsers</summary>
    public class RiskyUsersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.identityProtection.riskyUsers.item collection</summary>
        ...
        /// </summary>
        public RiskyUsersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RiskyUser body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
