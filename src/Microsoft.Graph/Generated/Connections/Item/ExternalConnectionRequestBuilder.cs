...
using MicrosoftGraph.Connections.Item.Groups;
using MicrosoftGraph.Connections.Item.Items;
using MicrosoftGraph.Connections.Item.Operations;
using MicrosoftGraph.Connections.Item.Schema;
...
namespace MicrosoftGraph.Connections.Item {
    ...
    public class ExternalConnectionRequestBuilder {
        ...
        /// </summary>
        public ExternalConnectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/connections/{externalConnection_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ExternalConnectionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <summary>Get entity from connections by key</summary>
