...
using MicrosoftGraph.Drives.Item.Bundles;
using MicrosoftGraph.Drives.Item.Following;
using MicrosoftGraph.Drives.Item.Items;
using MicrosoftGraph.Drives.Item.List;
using MicrosoftGraph.Drives.Item.Recent;
using MicrosoftGraph.Drives.Item.Root;
using MicrosoftGraph.Drives.Item.SearchWithQ;
using MicrosoftGraph.Drives.Item.SharedWithMe;
using MicrosoftGraph.Drives.Item.Special;
...
namespace MicrosoftGraph.Drives.Item {
    ...
    public class DriveRequestBuilder {
        ...
        public DriveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}{?select,expand}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraph.Models.Microsoft.Graph.Drive body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraph.Models.Microsoft.Graph.Drive> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<MicrosoftGraph.Models.Microsoft.Graph.Drive>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// Update entity in drives
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraph.Models.Microsoft.Graph.Drive body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
