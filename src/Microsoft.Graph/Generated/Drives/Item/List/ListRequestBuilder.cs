...
using MicrosoftGraph.Drives.Item.List.Columns;
using MicrosoftGraph.Drives.Item.List.ContentTypes;
using MicrosoftGraph.Drives.Item.List.Drive;
using MicrosoftGraph.Drives.Item.List.Items;
using MicrosoftGraph.Drives.Item.List.Subscriptions;
...
namespace MicrosoftGraph.Drives.Item.List {
    ...
    public class ListRequestBuilder {
        ...
        public ListRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list{?select,expand}";
