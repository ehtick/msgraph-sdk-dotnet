...
using MicrosoftGraph.Drives.Item.List.Items.Item.Analytics;
using MicrosoftGraph.Drives.Item.List.Items.Item.DriveItem;
using MicrosoftGraph.Drives.Item.List.Items.Item.Fields;
using MicrosoftGraph.Drives.Item.List.Items.Item.GetActivitiesByInterval;
using MicrosoftGraph.Drives.Item.List.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraph.Drives.Item.List.Items.Item.Versions;
...
namespace MicrosoftGraph.Drives.Item.List.Items.Item {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\items\{listItem-id}</summary>
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/items/{listItem_id}{?select,expand}";
