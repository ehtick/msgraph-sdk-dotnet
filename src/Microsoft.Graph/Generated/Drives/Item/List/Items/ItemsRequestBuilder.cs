...
namespace MicrosoftGraph.Drives.Item.List.Items {
    /// <summary>Builds and executes requests for operations under \drives\{drive-id}\list\items</summary>
    public class ItemsRequestBuilder {
        ...
        public ItemsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive_id}/list/items{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
