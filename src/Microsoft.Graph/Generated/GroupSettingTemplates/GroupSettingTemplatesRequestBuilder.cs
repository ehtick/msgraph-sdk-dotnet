...
using MicrosoftGraph.GroupSettingTemplates.GetAvailableExtensionProperties;
using MicrosoftGraph.GroupSettingTemplates.GetByIds;
using MicrosoftGraph.GroupSettingTemplates.Item;
using MicrosoftGraph.GroupSettingTemplates.ValidateProperties;
...
namespace MicrosoftGraph.GroupSettingTemplates {
    ...
    public class GroupSettingTemplatesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.groupSettingTemplates.item collection</summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GroupSettingTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
