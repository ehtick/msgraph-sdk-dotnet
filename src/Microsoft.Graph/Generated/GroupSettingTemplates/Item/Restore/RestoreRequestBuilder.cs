...
namespace MicrosoftGraph.GroupSettingTemplates.Item.Restore {
    /// <summary>Builds and executes requests for operations under \groupSettingTemplates\{groupSettingTemplate-id}\microsoft.graph.restore</summary>
    public class RestoreRequestBuilder {
        ...
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groupSettingTemplates/{groupSettingTemplate_id}/microsoft.graph.restore";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public RestoreRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
