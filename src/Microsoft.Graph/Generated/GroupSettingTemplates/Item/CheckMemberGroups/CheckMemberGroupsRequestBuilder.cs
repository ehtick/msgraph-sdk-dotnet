...
namespace MicrosoftGraph.GroupSettingTemplates.Item.CheckMemberGroups {
    /// <summary>Builds and executes requests for operations under \groupSettingTemplates\{groupSettingTemplate-id}\microsoft.graph.checkMemberGroups</summary>
    public class CheckMemberGroupsRequestBuilder {
        ...
        /// </summary>
        public CheckMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/groupSettingTemplates/{groupSettingTemplate_id}/microsoft.graph.checkMemberGroups";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public CheckMemberGroupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
