...
using MicrosoftGraph.GroupSettingTemplates.Item.CheckMemberGroups;
using MicrosoftGraph.GroupSettingTemplates.Item.CheckMemberObjects;
using MicrosoftGraph.GroupSettingTemplates.Item.GetMemberGroups;
using MicrosoftGraph.GroupSettingTemplates.Item.GetMemberObjects;
using MicrosoftGraph.GroupSettingTemplates.Item.Restore;
...
namespace MicrosoftGraph.GroupSettingTemplates.Item {
    ...
    public class GroupSettingTemplateRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public GroupSettingTemplateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(GroupSettingTemplate body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
