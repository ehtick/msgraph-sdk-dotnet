...
namespace MicrosoftGraph.GroupSettingTemplates.Item.GetMemberGroups {
    /// <summary>Builds and executes requests for operations under \groupSettingTemplates\{groupSettingTemplate-id}\microsoft.graph.getMemberGroups</summary>
    public class GetMemberGroupsRequestBuilder {
        ...
        /// </summary>
        public GetMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/groupSettingTemplates/{groupSettingTemplate_id}/microsoft.graph.getMemberGroups";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public GetMemberGroupsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
