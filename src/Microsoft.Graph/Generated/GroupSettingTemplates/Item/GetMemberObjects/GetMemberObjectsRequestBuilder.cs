...
namespace MicrosoftGraph.GroupSettingTemplates.Item.GetMemberObjects {
    /// <summary>Builds and executes requests for operations under \groupSettingTemplates\{groupSettingTemplate-id}\microsoft.graph.getMemberObjects</summary>
    public class GetMemberObjectsRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groupSettingTemplates/{groupSettingTemplate_id}/microsoft.graph.getMemberObjects";
