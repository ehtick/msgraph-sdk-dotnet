...
namespace MicrosoftGraph.GroupSettingTemplates.GetAvailableExtensionProperties {
    /// <summary>Builds and executes requests for operations under \groupSettingTemplates\microsoft.graph.getAvailableExtensionProperties</summary>
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public GetAvailableExtensionPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groupSettingTemplates/microsoft.graph.getAvailableExtensionProperties";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetAvailableExtensionPropertiesRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
