...
using MicrosoftGraph.Print.Shares.Item.Printer.Ref;
using MicrosoftGraph.Print.Shares.Item.Printer.RestoreFactoryDefaults;
using System;
...
namespace MicrosoftGraph.Print.Shares.Item.Printer {
    ...
    public class PrinterRequestBuilder {
        ...
        public PrinterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/print/shares/{printerShare_id}/printer{?select,expand}";
