...
using MicrosoftGraph.Print.Printers.Item.Connectors;
using MicrosoftGraph.Print.Printers.Item.RestoreFactoryDefaults;
using MicrosoftGraph.Print.Printers.Item.Shares;
using MicrosoftGraph.Print.Printers.Item.TaskTriggers;
using System;
...
namespace MicrosoftGraph.Print.Printers.Item {
    ...
    public class PrinterRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraph.Models.Microsoft.Graph.Printer body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraph.Models.Microsoft.Graph.Printer body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
