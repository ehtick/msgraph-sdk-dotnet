...
namespace MicrosoftGraph.Reports.GetSharePointActivityPagesWithPeriod {
    ...
    public class GetSharePointActivityPagesWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetSharePointActivityPagesWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/microsoft.graph.getSharePointActivityPages(period='{period}')";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public GetSharePointActivityPagesWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
