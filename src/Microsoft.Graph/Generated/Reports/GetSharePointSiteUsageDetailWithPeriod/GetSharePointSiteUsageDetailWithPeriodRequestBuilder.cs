...
namespace MicrosoftGraph.Reports.GetSharePointSiteUsageDetailWithPeriod {
    ...
    public class GetSharePointSiteUsageDetailWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetSharePointSiteUsageDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/microsoft.graph.getSharePointSiteUsageDetail(period='{period}')";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public GetSharePointSiteUsageDetailWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
