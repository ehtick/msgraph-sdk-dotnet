...
using MicrosoftGraph.Reports.DailyPrintUsageByPrinter;
using MicrosoftGraph.Reports.DailyPrintUsageByUser;
using MicrosoftGraph.Reports.DeviceConfigurationDeviceActivity;
using MicrosoftGraph.Reports.DeviceConfigurationUserActivity;
using MicrosoftGraph.Reports.GetEmailActivityCountsWithPeriod;
using MicrosoftGraph.Reports.GetEmailActivityUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetEmailActivityUserDetailWithDate;
using MicrosoftGraph.Reports.GetEmailActivityUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetEmailAppUsageAppsUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetEmailAppUsageUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetEmailAppUsageUserDetailWithDate;
using MicrosoftGraph.Reports.GetEmailAppUsageUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetEmailAppUsageVersionsUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTime;
using MicrosoftGraph.Reports.GetMailboxUsageDetailWithPeriod;
using MicrosoftGraph.Reports.GetMailboxUsageMailboxCountsWithPeriod;
using MicrosoftGraph.Reports.GetMailboxUsageQuotaStatusMailboxCountsWithPeriod;
using MicrosoftGraph.Reports.GetMailboxUsageStorageWithPeriod;
using MicrosoftGraph.Reports.GetOffice365ActivationCounts;
using MicrosoftGraph.Reports.GetOffice365ActivationsUserCounts;
using MicrosoftGraph.Reports.GetOffice365ActivationsUserDetail;
using MicrosoftGraph.Reports.GetOffice365ActiveUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetOffice365ActiveUserDetailWithDate;
using MicrosoftGraph.Reports.GetOffice365ActiveUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetOffice365GroupsActivityCountsWithPeriod;
using MicrosoftGraph.Reports.GetOffice365GroupsActivityDetailWithDate;
using MicrosoftGraph.Reports.GetOffice365GroupsActivityDetailWithPeriod;
using MicrosoftGraph.Reports.GetOffice365GroupsActivityFileCountsWithPeriod;
using MicrosoftGraph.Reports.GetOffice365GroupsActivityGroupCountsWithPeriod;
using MicrosoftGraph.Reports.GetOffice365GroupsActivityStorageWithPeriod;
using MicrosoftGraph.Reports.GetOffice365ServicesUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetOneDriveActivityFileCountsWithPeriod;
using MicrosoftGraph.Reports.GetOneDriveActivityUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetOneDriveActivityUserDetailWithDate;
using MicrosoftGraph.Reports.GetOneDriveActivityUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetOneDriveUsageAccountCountsWithPeriod;
using MicrosoftGraph.Reports.GetOneDriveUsageAccountDetailWithDate;
using MicrosoftGraph.Reports.GetOneDriveUsageAccountDetailWithPeriod;
using MicrosoftGraph.Reports.GetOneDriveUsageFileCountsWithPeriod;
using MicrosoftGraph.Reports.GetOneDriveUsageStorageWithPeriod;
using MicrosoftGraph.Reports.GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTime;
using MicrosoftGraph.Reports.GetSharePointActivityFileCountsWithPeriod;
using MicrosoftGraph.Reports.GetSharePointActivityPagesWithPeriod;
using MicrosoftGraph.Reports.GetSharePointActivityUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetSharePointActivityUserDetailWithDate;
using MicrosoftGraph.Reports.GetSharePointActivityUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetSharePointSiteUsageDetailWithDate;
using MicrosoftGraph.Reports.GetSharePointSiteUsageDetailWithPeriod;
using MicrosoftGraph.Reports.GetSharePointSiteUsageFileCountsWithPeriod;
using MicrosoftGraph.Reports.GetSharePointSiteUsagePagesWithPeriod;
using MicrosoftGraph.Reports.GetSharePointSiteUsageSiteCountsWithPeriod;
using MicrosoftGraph.Reports.GetSharePointSiteUsageStorageWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessActivityCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessActivityUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessActivityUserDetailWithDate;
using MicrosoftGraph.Reports.GetSkypeForBusinessActivityUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessDeviceUsageUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessDeviceUsageUserDetailWithDate;
using MicrosoftGraph.Reports.GetSkypeForBusinessDeviceUsageUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessOrganizerActivityCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessOrganizerActivityUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessParticipantActivityCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessParticipantActivityMinuteCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessParticipantActivityUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessPeerToPeerActivityCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessPeerToPeerActivityMinuteCountsWithPeriod;
using MicrosoftGraph.Reports.GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetTeamsDeviceUsageDistributionUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetTeamsDeviceUsageUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetTeamsDeviceUsageUserDetailWithDate;
using MicrosoftGraph.Reports.GetTeamsDeviceUsageUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetTeamsUserActivityCountsWithPeriod;
using MicrosoftGraph.Reports.GetTeamsUserActivityUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetTeamsUserActivityUserDetailWithDate;
using MicrosoftGraph.Reports.GetTeamsUserActivityUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetUserArchivedPrintJobsWithUserIdWithStartDateTimeWithEndDateTime;
using MicrosoftGraph.Reports.GetYammerActivityCountsWithPeriod;
using MicrosoftGraph.Reports.GetYammerActivityUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetYammerActivityUserDetailWithDate;
using MicrosoftGraph.Reports.GetYammerActivityUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetYammerDeviceUsageDistributionUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetYammerDeviceUsageUserCountsWithPeriod;
using MicrosoftGraph.Reports.GetYammerDeviceUsageUserDetailWithDate;
using MicrosoftGraph.Reports.GetYammerDeviceUsageUserDetailWithPeriod;
using MicrosoftGraph.Reports.GetYammerGroupsActivityCountsWithPeriod;
using MicrosoftGraph.Reports.GetYammerGroupsActivityDetailWithDate;
using MicrosoftGraph.Reports.GetYammerGroupsActivityDetailWithPeriod;
using MicrosoftGraph.Reports.GetYammerGroupsActivityGroupCountsWithPeriod;
using MicrosoftGraph.Reports.ManagedDeviceEnrollmentFailureDetails;
using MicrosoftGraph.Reports.ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipToken;
using MicrosoftGraph.Reports.ManagedDeviceEnrollmentTopFailures;
using MicrosoftGraph.Reports.ManagedDeviceEnrollmentTopFailuresWithPeriod;
using MicrosoftGraph.Reports.MonthlyPrintUsageByPrinter;
using MicrosoftGraph.Reports.MonthlyPrintUsageByUser;
using System;
...
namespace MicrosoftGraph.Reports {
