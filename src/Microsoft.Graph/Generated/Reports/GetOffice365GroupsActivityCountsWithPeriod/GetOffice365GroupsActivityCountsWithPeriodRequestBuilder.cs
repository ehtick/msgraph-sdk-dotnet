...
namespace MicrosoftGraph.Reports.GetOffice365GroupsActivityCountsWithPeriod {
    ...
    public class GetOffice365GroupsActivityCountsWithPeriodRequestBuilder {
        ...
        public GetOffice365GroupsActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
            ...
            UrlTemplate = "{+baseurl}/reports/microsoft.graph.getOffice365GroupsActivityCounts(period='{period}')";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public GetOffice365GroupsActivityCountsWithPeriodRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
