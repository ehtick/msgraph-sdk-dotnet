...
namespace MicrosoftGraph.Reports.GetSharePointSiteUsageStorageWithPeriod {
    /// <summary>Builds and executes requests for operations under \reports\microsoft.graph.getSharePointSiteUsageStorage(period='{period}')</summary>
    public class GetSharePointSiteUsageStorageWithPeriodRequestBuilder {
        ...
        /// </summary>
        public GetSharePointSiteUsageStorageWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = default) {
