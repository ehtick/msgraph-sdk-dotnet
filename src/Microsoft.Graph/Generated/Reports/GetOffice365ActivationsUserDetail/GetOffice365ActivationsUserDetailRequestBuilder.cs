...
namespace MicrosoftGraph.Reports.GetOffice365ActivationsUserDetail {
    ...
    public class GetOffice365ActivationsUserDetailRequestBuilder {
        ...
        /// </summary>
        public GetOffice365ActivationsUserDetailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/reports/microsoft.graph.getOffice365ActivationsUserDetail()";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public GetOffice365ActivationsUserDetailRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
