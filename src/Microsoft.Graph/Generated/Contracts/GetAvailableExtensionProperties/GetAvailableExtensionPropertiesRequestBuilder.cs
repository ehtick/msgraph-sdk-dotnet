...
namespace MicrosoftGraph.Contracts.GetAvailableExtensionProperties {
    /// <summary>Builds and executes requests for operations under \contracts\microsoft.graph.getAvailableExtensionProperties</summary>
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public GetAvailableExtensionPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contracts/microsoft.graph.getAvailableExtensionProperties";
