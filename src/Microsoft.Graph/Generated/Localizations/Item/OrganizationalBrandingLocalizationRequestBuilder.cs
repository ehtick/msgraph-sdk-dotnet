...
namespace MicrosoftGraph.Localizations.Item {
    /// <summary>Builds and executes requests for operations under \localizations\{organizationalBrandingLocalization-id}</summary>
    public class OrganizationalBrandingLocalizationRequestBuilder {
        ...
        /// </summary>
        public OrganizationalBrandingLocalizationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/localizations/{organizationalBrandingLocalization_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public OrganizationalBrandingLocalizationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
