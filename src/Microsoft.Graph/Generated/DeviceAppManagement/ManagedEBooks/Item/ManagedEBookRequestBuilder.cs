...
using MicrosoftGraph.DeviceAppManagement.ManagedEBooks.Item.Assign;
using MicrosoftGraph.DeviceAppManagement.ManagedEBooks.Item.Assignments;
using MicrosoftGraph.DeviceAppManagement.ManagedEBooks.Item.DeviceStates;
using MicrosoftGraph.DeviceAppManagement.ManagedEBooks.Item.InstallSummary;
using MicrosoftGraph.DeviceAppManagement.ManagedEBooks.Item.UserStateSummary;
...
namespace MicrosoftGraph.DeviceAppManagement.ManagedEBooks.Item {
    ...
    public class ManagedEBookRequestBuilder {
        ...
        public ManagedEBookRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook_id}{?select,expand}";
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ManagedEBook body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ManagedEBook body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
