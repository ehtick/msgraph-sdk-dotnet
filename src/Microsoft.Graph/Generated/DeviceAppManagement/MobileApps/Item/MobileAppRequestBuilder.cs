...
using MicrosoftGraph.DeviceAppManagement.MobileApps.Item.Assign;
using MicrosoftGraph.DeviceAppManagement.MobileApps.Item.Assignments;
using MicrosoftGraph.DeviceAppManagement.MobileApps.Item.Categories;
...
namespace MicrosoftGraph.DeviceAppManagement.MobileApps.Item {
    ...
    public class MobileAppRequestBuilder {
        ...
        /// </summary>
        public MobileAppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
