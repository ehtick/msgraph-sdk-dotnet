...
using MicrosoftGraph.Me.Calendar.Events.Item.Accept;
using MicrosoftGraph.Me.Calendar.Events.Item.Attachments;
using MicrosoftGraph.Me.Calendar.Events.Item.Calendar;
using MicrosoftGraph.Me.Calendar.Events.Item.Cancel;
using MicrosoftGraph.Me.Calendar.Events.Item.Decline;
using MicrosoftGraph.Me.Calendar.Events.Item.DismissReminder;
using MicrosoftGraph.Me.Calendar.Events.Item.Extensions;
using MicrosoftGraph.Me.Calendar.Events.Item.Forward;
using MicrosoftGraph.Me.Calendar.Events.Item.Instances;
using MicrosoftGraph.Me.Calendar.Events.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Me.Calendar.Events.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Me.Calendar.Events.Item.SnoozeReminder;
using MicrosoftGraph.Me.Calendar.Events.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Me.Calendar.Events.Item {
    /// <summary>Builds and executes requests for operations under \me\calendar\events\{event-id}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/events/{event_id}{?select}";
