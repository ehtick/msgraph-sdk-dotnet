...
using MicrosoftGraph.Me.Calendar.CalendarView.Item.Accept;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.Attachments;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.Calendar;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.Cancel;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.Decline;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.DismissReminder;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.Extensions;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.Forward;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.Instances;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.SnoozeReminder;
using MicrosoftGraph.Me.Calendar.CalendarView.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Me.Calendar.CalendarView.Item {
    /// <summary>Builds and executes requests for operations under \me\calendar\calendarView\{event-id}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/calendarView/{event_id}{?startDateTime,endDateTime,select}";
