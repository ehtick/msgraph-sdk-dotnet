...
using MicrosoftGraph.Me.Events.Item.Accept;
using MicrosoftGraph.Me.Events.Item.Attachments;
using MicrosoftGraph.Me.Events.Item.Calendar;
using MicrosoftGraph.Me.Events.Item.Cancel;
using MicrosoftGraph.Me.Events.Item.Decline;
using MicrosoftGraph.Me.Events.Item.DismissReminder;
using MicrosoftGraph.Me.Events.Item.Extensions;
using MicrosoftGraph.Me.Events.Item.Forward;
using MicrosoftGraph.Me.Events.Item.Instances;
using MicrosoftGraph.Me.Events.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Me.Events.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Me.Events.Item.SnoozeReminder;
using MicrosoftGraph.Me.Events.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Me.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/events/{event_id}{?select}";
