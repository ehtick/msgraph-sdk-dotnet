...
using MicrosoftGraph.Me.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords;
...
namespace MicrosoftGraph.Me.OnlineMeetings.Item.AttendanceReports.Item {
    /// <summary>Builds and executes requests for operations under \me\onlineMeetings\{onlineMeeting-id}\attendanceReports\{meetingAttendanceReport-id}</summary>
    public class MeetingAttendanceReportRequestBuilder {
        ...
        public MeetingAttendanceReportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onlineMeetings/{onlineMeeting_id}/attendanceReports/{meetingAttendanceReport_id}{?select,expand}";
