...
using MicrosoftGraph.Me.OnlineMeetings.Item.AttendanceReports;
using MicrosoftGraph.Me.OnlineMeetings.Item.AttendeeReport;
...
namespace MicrosoftGraph.Me.OnlineMeetings.Item {
    ...
    public class OnlineMeetingRequestBuilder {
        ...
        public OnlineMeetingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/onlineMeetings/{onlineMeeting_id}{?select,expand}";
