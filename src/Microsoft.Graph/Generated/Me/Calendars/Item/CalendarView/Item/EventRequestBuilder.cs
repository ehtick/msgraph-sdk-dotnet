...
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Accept;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Attachments;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Calendar;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Cancel;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Decline;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.DismissReminder;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Extensions;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Forward;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.Instances;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.SnoozeReminder;
using MicrosoftGraph.Me.Calendars.Item.CalendarView.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Me.Calendars.Item.CalendarView.Item {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\calendarView\{event-id}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/calendarView/{event_id}{?startDateTime,endDateTime,select}";
