...
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Accept;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Attachments;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Calendar;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Cancel;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Decline;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.DismissReminder;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Extensions;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Forward;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.Instances;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.SnoozeReminder;
using MicrosoftGraph.Me.Calendars.Item.Events.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Me.Calendars.Item.Events.Item {
    /// <summary>Builds and executes requests for operations under \me\calendars\{calendar-id}\events\{event-id}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events/{event_id}{?select}";
