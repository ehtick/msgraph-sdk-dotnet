...
using MicrosoftGraph.Me.JoinedTeams.Item;
...
namespace MicrosoftGraph.Me.JoinedTeams {
    /// <summary>Builds and executes requests for operations under \me\joinedTeams</summary>
    public class JoinedTeamsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.joinedTeams.item collection</summary>
        ...
        public JoinedTeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
