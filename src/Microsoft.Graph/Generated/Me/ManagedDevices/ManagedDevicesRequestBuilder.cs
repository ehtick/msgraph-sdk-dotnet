...
namespace MicrosoftGraph.Me.ManagedDevices {
    /// <summary>Builds and executes requests for operations under \me\managedDevices</summary>
    public class ManagedDevicesRequestBuilder {
        ...
        public ManagedDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/managedDevices{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
