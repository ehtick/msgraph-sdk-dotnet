...
using MicrosoftGraph.Me.ManagedDevices.Item.BypassActivationLock;
using MicrosoftGraph.Me.ManagedDevices.Item.CleanWindowsDevice;
using MicrosoftGraph.Me.ManagedDevices.Item.DeleteUserFromSharedAppleDevice;
using MicrosoftGraph.Me.ManagedDevices.Item.DeviceCategory;
using MicrosoftGraph.Me.ManagedDevices.Item.DeviceCompliancePolicyStates;
using MicrosoftGraph.Me.ManagedDevices.Item.DeviceConfigurationStates;
using MicrosoftGraph.Me.ManagedDevices.Item.DisableLostMode;
using MicrosoftGraph.Me.ManagedDevices.Item.LocateDevice;
using MicrosoftGraph.Me.ManagedDevices.Item.LogoutSharedAppleDeviceActiveUser;
using MicrosoftGraph.Me.ManagedDevices.Item.RebootNow;
using MicrosoftGraph.Me.ManagedDevices.Item.RecoverPasscode;
using MicrosoftGraph.Me.ManagedDevices.Item.RemoteLock;
using MicrosoftGraph.Me.ManagedDevices.Item.RequestRemoteAssistance;
using MicrosoftGraph.Me.ManagedDevices.Item.ResetPasscode;
using MicrosoftGraph.Me.ManagedDevices.Item.Retire;
using MicrosoftGraph.Me.ManagedDevices.Item.ShutDown;
using MicrosoftGraph.Me.ManagedDevices.Item.SyncDevice;
using MicrosoftGraph.Me.ManagedDevices.Item.UpdateWindowsDeviceAccount;
using MicrosoftGraph.Me.ManagedDevices.Item.WindowsDefenderScan;
using MicrosoftGraph.Me.ManagedDevices.Item.WindowsDefenderUpdateSignatures;
using MicrosoftGraph.Me.ManagedDevices.Item.Wipe;
...
namespace MicrosoftGraph.Me.ManagedDevices.Item {
