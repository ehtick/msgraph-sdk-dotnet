...
using MicrosoftGraph.Me.CalendarView.Item.Accept;
using MicrosoftGraph.Me.CalendarView.Item.Attachments;
using MicrosoftGraph.Me.CalendarView.Item.Calendar;
using MicrosoftGraph.Me.CalendarView.Item.Cancel;
using MicrosoftGraph.Me.CalendarView.Item.Decline;
using MicrosoftGraph.Me.CalendarView.Item.DismissReminder;
using MicrosoftGraph.Me.CalendarView.Item.Extensions;
using MicrosoftGraph.Me.CalendarView.Item.Forward;
using MicrosoftGraph.Me.CalendarView.Item.Instances;
using MicrosoftGraph.Me.CalendarView.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Me.CalendarView.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Me.CalendarView.Item.SnoozeReminder;
using MicrosoftGraph.Me.CalendarView.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Me.CalendarView.Item {
