...
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.BoundingRectWithAnotherRange;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.CellWithRowWithColumn;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.Clear;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnsAfter;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnsAfterWithCount;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnsBefore;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnsBeforeWithCount;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnWithColumn;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.Delete;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.EntireColumn;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.EntireRow;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.Insert;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.IntersectionWithAnotherRange;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.LastCell;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.LastColumn;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.LastRow;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.Merge;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.RowsAbove;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.RowsAboveWithCount;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.RowsBelow;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.RowsBelowWithCount;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.RowWithRow;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.Unmerge;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.UsedRange;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.UsedRangeWithValuesOnly;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.VisibleView;
using System;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
namespace MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange {
