...
namespace MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange.CellWithRowWithColumn {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trending-id}\resource\microsoft.graph.workbookRange\microsoft.graph.cell(row={row},column={column})</summary>
    public class CellWithRowWithColumnRequestBuilder {
        ...
        public CellWithRowWithColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? row = default, int? column = default) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trending_id}/resource/microsoft.graph.workbookRange/microsoft.graph.cell(row={row},column={column})";
