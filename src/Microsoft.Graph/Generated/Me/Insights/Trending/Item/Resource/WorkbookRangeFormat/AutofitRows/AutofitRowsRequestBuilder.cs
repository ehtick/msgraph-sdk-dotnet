...
namespace MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRangeFormat.AutofitRows {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trending-id}\resource\microsoft.graph.workbookRangeFormat\microsoft.graph.autofitRows</summary>
    public class AutofitRowsRequestBuilder {
        ...
        public AutofitRowsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trending_id}/resource/microsoft.graph.workbookRangeFormat/microsoft.graph.autofitRows";
