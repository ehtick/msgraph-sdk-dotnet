...
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.CalendarSharingMessage;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.ManagedAppProtection;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.MobileAppContentFile;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.PrintDocument;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.PrintJob;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.Ref;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.ScheduleChangeRequest;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.TargetedManagedAppProtection;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WindowsInformationProtection;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRange;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRangeFill;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRangeFormat;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRangeSort;
using MicrosoftGraph.Me.Insights.Trending.Item.Resource.WorkbookRangeView;
...
namespace MicrosoftGraph.Me.Insights.Trending.Item.Resource {
