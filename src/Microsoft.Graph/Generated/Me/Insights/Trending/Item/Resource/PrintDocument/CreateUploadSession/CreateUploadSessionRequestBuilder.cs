...
namespace MicrosoftGraph.Me.Insights.Trending.Item.Resource.PrintDocument.CreateUploadSession {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trending-id}\resource\microsoft.graph.printDocument\microsoft.graph.createUploadSession</summary>
    public class CreateUploadSessionRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trending_id}/resource/microsoft.graph.printDocument/microsoft.graph.createUploadSession";
