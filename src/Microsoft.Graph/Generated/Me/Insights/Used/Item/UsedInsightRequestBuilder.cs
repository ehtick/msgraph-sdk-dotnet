...
using MicrosoftGraph.Me.Insights.Used.Item.Resource;
...
namespace MicrosoftGraph.Me.Insights.Used.Item {
    ...
    public class UsedInsightRequestBuilder {
        ...
        public UsedInsightRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/used/{usedInsight_id}{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public UsedInsightRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(UsedInsight body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
