...
using MicrosoftGraph.Me.Insights.Used.Item.Resource.CalendarSharingMessage;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.ManagedAppProtection;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.MobileAppContentFile;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.PrintDocument;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.PrintJob;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.Ref;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.ScheduleChangeRequest;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.TargetedManagedAppProtection;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.WindowsInformationProtection;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.WorkbookRange;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.WorkbookRangeFill;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.WorkbookRangeFormat;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.WorkbookRangeSort;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.WorkbookRangeView;
...
namespace MicrosoftGraph.Me.Insights.Used.Item.Resource {
