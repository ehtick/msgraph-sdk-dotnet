...
namespace MicrosoftGraph.Me.Insights.Used.Item.Resource.WorkbookRange.VisibleView {
    /// <summary>Builds and executes requests for operations under \me\insights\used\{usedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.visibleView()</summary>
    public class VisibleViewRequestBuilder {
        ...
        public VisibleViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/used/{usedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.visibleView()";
