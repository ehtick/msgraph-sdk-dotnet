...
namespace MicrosoftGraph.Me.Insights.Used.Item.Resource.PrintJob.Cancel {
    /// <summary>Builds and executes requests for operations under \me\insights\used\{usedInsight-id}\resource\microsoft.graph.printJob\microsoft.graph.cancel</summary>
    public class CancelRequestBuilder {
        ...
        public CancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/used/{usedInsight_id}/resource/microsoft.graph.printJob/microsoft.graph.cancel";
