...
using MicrosoftGraph.Me.Insights.Used.Item.Resource.TargetedManagedAppProtection.Assign;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.TargetedManagedAppProtection.TargetApps;
using System;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
namespace MicrosoftGraph.Me.Insights.Used.Item.Resource.TargetedManagedAppProtection {
    ...
    public class TargetedManagedAppProtectionRequestBuilder {
        ...
        public TargetedManagedAppProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/used/{usedInsight_id}/resource/microsoft.graph.targetedManagedAppProtection";
