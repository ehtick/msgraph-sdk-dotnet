...
using MicrosoftGraph.Me.Insights.Used.Item.Resource.MobileAppContentFile.Commit;
using MicrosoftGraph.Me.Insights.Used.Item.Resource.MobileAppContentFile.RenewUpload;
using System;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
namespace MicrosoftGraph.Me.Insights.Used.Item.Resource.MobileAppContentFile {
    ...
    public class MobileAppContentFileRequestBuilder {
        ...
        public MobileAppContentFileRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/used/{usedInsight_id}/resource/microsoft.graph.mobileAppContentFile";
