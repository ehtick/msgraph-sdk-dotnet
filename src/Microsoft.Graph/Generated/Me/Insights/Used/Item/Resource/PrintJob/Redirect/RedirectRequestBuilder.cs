...
namespace MicrosoftGraph.Me.Insights.Used.Item.Resource.PrintJob.Redirect {
    /// <summary>Builds and executes requests for operations under \me\insights\used\{usedInsight-id}\resource\microsoft.graph.printJob\microsoft.graph.redirect</summary>
    public class RedirectRequestBuilder {
        ...
        public RedirectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/used/{usedInsight_id}/resource/microsoft.graph.printJob/microsoft.graph.redirect";
