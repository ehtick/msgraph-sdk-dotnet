...
namespace MicrosoftGraph.Me.Insights.Used.Item.Resource.PrintJob.Start {
    /// <summary>Builds and executes requests for operations under \me\insights\used\{usedInsight-id}\resource\microsoft.graph.printJob\microsoft.graph.start</summary>
    public class StartRequestBuilder {
        ...
        public StartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/used/{usedInsight_id}/resource/microsoft.graph.printJob/microsoft.graph.start";
