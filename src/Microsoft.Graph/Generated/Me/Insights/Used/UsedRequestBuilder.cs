...
using MicrosoftGraph.Me.Insights.Used.Item;
...
namespace MicrosoftGraph.Me.Insights.Used {
    /// <summary>Builds and executes requests for operations under \me\insights\used</summary>
    public class UsedRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.insights.used.item collection</summary>
        ...
        public UsedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/used{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
