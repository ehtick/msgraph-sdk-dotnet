...
using MicrosoftGraph.Me.Insights.Shared;
using MicrosoftGraph.Me.Insights.Trending;
using MicrosoftGraph.Me.Insights.Used;
...
namespace MicrosoftGraph.Me.Insights {
    ...
    public class InsightsRequestBuilder {
        ...
        public InsightsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights{?select,expand}";
