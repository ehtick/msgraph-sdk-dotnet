...
using MicrosoftGraph.Me.Insights.Shared.Item;
...
namespace MicrosoftGraph.Me.Insights.Shared {
    ...
    public class SharedRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.me.insights.shared.item collection</summary>
        ...
        public SharedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
