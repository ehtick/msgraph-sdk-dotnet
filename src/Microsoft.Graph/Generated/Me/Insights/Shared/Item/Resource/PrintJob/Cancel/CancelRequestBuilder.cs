...
namespace MicrosoftGraph.Me.Insights.Shared.Item.Resource.PrintJob.Cancel {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.printJob\microsoft.graph.cancel</summary>
    public class CancelRequestBuilder {
        ...
        public CancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.printJob/microsoft.graph.cancel";
