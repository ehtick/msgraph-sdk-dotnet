...
namespace MicrosoftGraph.Me.Insights.Shared.Item.Resource.PrintJob.Start {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.printJob\microsoft.graph.start</summary>
    public class StartRequestBuilder {
        ...
        public StartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.printJob/microsoft.graph.start";
