...
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.CalendarSharingMessage;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.ManagedAppProtection;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.MobileAppContentFile;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.PrintDocument;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.PrintJob;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.Ref;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.ScheduleChangeRequest;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.TargetedManagedAppProtection;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WindowsInformationProtection;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRangeFill;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRangeFormat;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRangeSort;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRangeView;
...
namespace MicrosoftGraph.Me.Insights.Shared.Item.Resource {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource</summary>
    public class ResourceRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/resource{?select,expand}";
