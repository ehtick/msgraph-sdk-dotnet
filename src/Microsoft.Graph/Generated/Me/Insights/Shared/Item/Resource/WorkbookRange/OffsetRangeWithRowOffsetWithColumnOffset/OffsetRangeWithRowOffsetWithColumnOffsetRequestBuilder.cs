...
namespace MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset {
    ...
    public class OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder {
        ...
        public OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? rowOffset = default, int? columnOffset = default) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.offsetRange(rowOffset={rowOffset},columnOffset={columnOffset})";
