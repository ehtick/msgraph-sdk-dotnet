...
namespace MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.IntersectionWithAnotherRange {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.intersection(anotherRange='{anotherRange}')</summary>
    public class IntersectionWithAnotherRangeRequestBuilder {
        ...
        public IntersectionWithAnotherRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string anotherRange = default) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.intersection(anotherRange='{anotherRange}')";
