...
namespace MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.CellWithRowWithColumn {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.cell(row={row},column={column})</summary>
