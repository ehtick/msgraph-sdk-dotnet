...
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.BoundingRectWithAnotherRange;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.CellWithRowWithColumn;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.Clear;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnsAfter;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnsAfterWithCount;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnsBefore;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnsBeforeWithCount;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnWithColumn;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.Delete;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.EntireColumn;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.EntireRow;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.Insert;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.IntersectionWithAnotherRange;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.LastCell;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.LastColumn;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.LastRow;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.Merge;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.RowsAbove;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.RowsAboveWithCount;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.RowsBelow;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.RowsBelowWithCount;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.RowWithRow;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.Unmerge;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.UsedRange;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.UsedRangeWithValuesOnly;
using MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.VisibleView;
using System;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
namespace MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange</summary>
    public class WorkbookRangeRequestBuilder {
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.cell(row={row},column={column})
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.columnsAfter()
        /// </summary>
        public ColumnsAfterRequestBuilder ColumnsAfter() {
            return new ColumnsAfterRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.columnsAfter(count={count})
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.columnsBefore()
        /// </summary>
        public ColumnsBeforeRequestBuilder ColumnsBefore() {
            return new ColumnsBeforeRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.columnsBefore(count={count})
        /// <param name="count">Usage: count={count}</param>
        /// </summary>
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.column(column={column})
        /// <param name="column">Usage: column={column}</param>
        /// </summary>
        ...
        public WorkbookRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRange";
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.entireColumn()
        /// </summary>
        public EntireColumnRequestBuilder EntireColumn() {
            return new EntireColumnRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.entireRow()
        /// </summary>
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.lastCell()
        /// </summary>
        public LastCellRequestBuilder LastCell() {
            return new LastCellRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.lastColumn()
        /// </summary>
        public LastColumnRequestBuilder LastColumn() {
            return new LastColumnRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.lastRow()
        /// </summary>
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.resizedRange(deltaRows={deltaRows},deltaColumns={deltaColumns})
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.rowsAbove(count={count})
        /// <param name="count">Usage: count={count}</param>
        /// </summary>
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.rowsBelow()
        /// </summary>
        public RowsBelowRequestBuilder RowsBelow() {
            return new RowsBelowRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.rowsBelow(count={count})
        /// <param name="count">Usage: count={count}</param>
        /// </summary>
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.row(row={row})
        /// <param name="row">Usage: row={row}</param>
        /// </summary>
        ...
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.usedRange()
        /// </summary>
        public UsedRangeRequestBuilder UsedRange() {
            return new UsedRangeRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.usedRange(valuesOnly={valuesOnly})
