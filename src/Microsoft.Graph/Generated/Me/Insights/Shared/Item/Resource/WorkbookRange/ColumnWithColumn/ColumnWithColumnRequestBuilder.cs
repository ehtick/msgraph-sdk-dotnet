...
namespace MicrosoftGraph.Me.Insights.Shared.Item.Resource.WorkbookRange.ColumnWithColumn {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\resource\microsoft.graph.workbookRange\microsoft.graph.column(column={column})</summary>
    public class ColumnWithColumnRequestBuilder {
        ...
        public ColumnWithColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? column = default) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/resource/microsoft.graph.workbookRange/microsoft.graph.column(column={column})";
