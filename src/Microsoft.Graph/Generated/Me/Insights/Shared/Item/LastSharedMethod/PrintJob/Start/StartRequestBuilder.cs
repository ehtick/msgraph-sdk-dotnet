...
namespace MicrosoftGraph.Me.Insights.Shared.Item.LastSharedMethod.PrintJob.Start {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\lastSharedMethod\microsoft.graph.printJob\microsoft.graph.start</summary>
    public class StartRequestBuilder {
        ...
        public StartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.printJob/microsoft.graph.start";
