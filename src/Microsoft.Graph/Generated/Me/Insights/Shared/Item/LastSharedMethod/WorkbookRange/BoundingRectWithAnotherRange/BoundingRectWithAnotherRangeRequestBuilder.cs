...
namespace MicrosoftGraph.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.BoundingRectWithAnotherRange {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\lastSharedMethod\microsoft.graph.workbookRange\microsoft.graph.boundingRect(anotherRange='{anotherRange}')</summary>
    public class BoundingRectWithAnotherRangeRequestBuilder {
        ...
        public BoundingRectWithAnotherRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string anotherRange = default) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.workbookRange/microsoft.graph.boundingRect(anotherRange='{anotherRange}')";
