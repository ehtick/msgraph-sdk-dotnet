...
namespace MicrosoftGraph.Me.Insights.Shared.Item.LastSharedMethod.PrintDocument.CreateUploadSession {
    /// <summary>Builds and executes requests for operations under \me\insights\shared\{sharedInsight-id}\lastSharedMethod\microsoft.graph.printDocument\microsoft.graph.createUploadSession</summary>
    public class CreateUploadSessionRequestBuilder {
        ...
        public CreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/shared/{sharedInsight_id}/lastSharedMethod/microsoft.graph.printDocument/microsoft.graph.createUploadSession";
