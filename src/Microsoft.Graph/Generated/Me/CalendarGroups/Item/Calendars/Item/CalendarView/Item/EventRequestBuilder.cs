...
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Accept;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Calendar;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Cancel;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Decline;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.DismissReminder;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Extensions;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Forward;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.SnoozeReminder;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item {
    /// <summary>Builds and executes requests for operations under \me\calendarGroups\{calendarGroup-id}\calendars\{calendar-id}\calendarView\{event-id}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendarGroups/{calendarGroup_id}/calendars/{calendar_id}/calendarView/{event_id}{?select}";
