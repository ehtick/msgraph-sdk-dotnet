...
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Accept;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Attachments;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Calendar;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Cancel;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Decline;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.DismissReminder;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Extensions;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Forward;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.SnoozeReminder;
using MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Me.CalendarGroups.Item.Calendars.Item.Events.Item {
