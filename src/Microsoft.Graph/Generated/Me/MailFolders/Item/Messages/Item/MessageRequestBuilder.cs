...
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.Attachments;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.CalendarSharingMessage;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.Copy;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.CreateForward;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.CreateReply;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.CreateReplyAll;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.Extensions;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.Forward;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.Move;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.Reply;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.ReplyAll;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.Send;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Me.MailFolders.Item.Messages.Item.Value;
...
namespace MicrosoftGraph.Me.MailFolders.Item.Messages.Item {
