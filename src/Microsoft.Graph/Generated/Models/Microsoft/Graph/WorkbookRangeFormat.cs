...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class WorkbookRangeFormat : Entity, IParsable {
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.WorkbookRangeFill Fill { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"fill", (o,n) => { (o as WorkbookRangeFormat).Fill = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WorkbookRangeFill>(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WorkbookRangeFill>("fill", Fill);
