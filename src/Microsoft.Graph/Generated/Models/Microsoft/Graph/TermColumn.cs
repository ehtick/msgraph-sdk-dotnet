...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class TermColumn : IParsable {
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.TermStore.Set TermSet { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"termSet", (o,n) => { (o as TermColumn).TermSet = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.TermStore.Set>(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.TermStore.Set>("termSet", TermSet);
