...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class DeviceManagement : Entity, IParsable {
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.ApplePushNotificationCertificate ApplePushNotificationCertificate { get; set; }
        ...
        public List<MicrosoftGraph.Models.Microsoft.Graph.DeviceCategory> DeviceCategories { get; set; }
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.DeviceCompliancePolicyDeviceStateSummary DeviceCompliancePolicyDeviceStateSummary { get; set; }
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.ManagedDeviceOverview ManagedDeviceOverview { get; set; }
        ...
        public List<MicrosoftGraph.Models.Microsoft.Graph.RoleDefinition> RoleDefinitions { get; set; }
        ...
        public MicrosoftGraph.Models.Microsoft.Graph.SoftwareUpdateStatusSummary SoftwareUpdateStatusSummary { get; set; }
        ...
        public List<MicrosoftGraph.Models.Microsoft.Graph.TermsAndConditions> TermsAndConditions { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"applePushNotificationCertificate", (o,n) => { (o as DeviceManagement).ApplePushNotificationCertificate = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.ApplePushNotificationCertificate>(); } },
                ...
                {"deviceCategories", (o,n) => { (o as DeviceManagement).DeviceCategories = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.DeviceCategory>().ToList(); } },
                ...
                {"deviceCompliancePolicyDeviceStateSummary", (o,n) => { (o as DeviceManagement).DeviceCompliancePolicyDeviceStateSummary = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.DeviceCompliancePolicyDeviceStateSummary>(); } },
                ...
                {"managedDeviceOverview", (o,n) => { (o as DeviceManagement).ManagedDeviceOverview = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.ManagedDeviceOverview>(); } },
                ...
                {"roleDefinitions", (o,n) => { (o as DeviceManagement).RoleDefinitions = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.RoleDefinition>().ToList(); } },
                {"settings", (o,n) => { (o as DeviceManagement).Settings = n.GetObjectValue<DeviceManagementSettings>(); } },
                {"softwareUpdateStatusSummary", (o,n) => { (o as DeviceManagement).SoftwareUpdateStatusSummary = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.SoftwareUpdateStatusSummary>(); } },
                ...
                {"termsAndConditions", (o,n) => { (o as DeviceManagement).TermsAndConditions = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.TermsAndConditions>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.ApplePushNotificationCertificate>("applePushNotificationCertificate", ApplePushNotificationCertificate);
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.DeviceCategory>("deviceCategories", DeviceCategories);
            writer.WriteCollectionOfObjectValues<DeviceCompliancePolicy>("deviceCompliancePolicies", DeviceCompliancePolicies);
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.DeviceCompliancePolicyDeviceStateSummary>("deviceCompliancePolicyDeviceStateSummary", DeviceCompliancePolicyDeviceStateSummary);
            ...
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.ManagedDeviceOverview>("managedDeviceOverview", ManagedDeviceOverview);
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.RoleDefinition>("roleDefinitions", RoleDefinitions);
            writer.WriteObjectValue<DeviceManagementSettings>("settings", Settings);
            writer.WriteObjectValue<MicrosoftGraph.Models.Microsoft.Graph.SoftwareUpdateStatusSummary>("softwareUpdateStatusSummary", SoftwareUpdateStatusSummary);
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.TermsAndConditions>("termsAndConditions", TermsAndConditions);
