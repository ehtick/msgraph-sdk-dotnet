...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class PrintJob : Entity, IParsable {
        ...
        public List<MicrosoftGraph.Models.Microsoft.Graph.PrintDocument> Documents { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"documents", (o,n) => { (o as PrintJob).Documents = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.PrintDocument>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.PrintDocument>("documents", Documents);
