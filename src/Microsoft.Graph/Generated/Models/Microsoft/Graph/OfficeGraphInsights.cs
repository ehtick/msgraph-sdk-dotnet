...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class OfficeGraphInsights : Entity, IParsable {
        ...
        public List<MicrosoftGraph.Models.Microsoft.Graph.Trending> Trending { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"trending", (o,n) => { (o as OfficeGraphInsights).Trending = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Trending>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.Trending>("trending", Trending);
