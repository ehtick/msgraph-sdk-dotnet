...
namespace MicrosoftGraph.Models.Microsoft.Graph {
    public class PrinterBase : Entity, IParsable {
        ...
        public List<MicrosoftGraph.Models.Microsoft.Graph.PrintJob> Jobs { get; set; }
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"jobs", (o,n) => { (o as PrinterBase).Jobs = n.GetCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.PrintJob>().ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<MicrosoftGraph.Models.Microsoft.Graph.PrintJob>("jobs", Jobs);
