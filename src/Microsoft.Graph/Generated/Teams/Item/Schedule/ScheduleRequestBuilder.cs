...
using MicrosoftGraph.Teams.Item.Schedule.OfferShiftRequests;
using MicrosoftGraph.Teams.Item.Schedule.OpenShiftChangeRequests;
using MicrosoftGraph.Teams.Item.Schedule.OpenShifts;
using MicrosoftGraph.Teams.Item.Schedule.SchedulingGroups;
using MicrosoftGraph.Teams.Item.Schedule.Share;
using MicrosoftGraph.Teams.Item.Schedule.Shifts;
using MicrosoftGraph.Teams.Item.Schedule.SwapShiftsChangeRequests;
using MicrosoftGraph.Teams.Item.Schedule.TimeOffReasons;
using MicrosoftGraph.Teams.Item.Schedule.TimeOffRequests;
using MicrosoftGraph.Teams.Item.Schedule.TimesOff;
using System;
...
namespace MicrosoftGraph.Teams.Item.Schedule {
    ...
    public class ScheduleRequestBuilder {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MicrosoftGraph.Models.Microsoft.Graph.Schedule body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftGraph.Models.Microsoft.Graph.Schedule> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<MicrosoftGraph.Models.Microsoft.Graph.Schedule>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// The schedule of shifts for this team.
        /// <param name="body"></param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(MicrosoftGraph.Models.Microsoft.Graph.Schedule body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
