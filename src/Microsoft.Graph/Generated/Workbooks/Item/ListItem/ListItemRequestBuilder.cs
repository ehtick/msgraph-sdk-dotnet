...
using MicrosoftGraph.Workbooks.Item.ListItem.Analytics;
using MicrosoftGraph.Workbooks.Item.ListItem.DriveItem;
using MicrosoftGraph.Workbooks.Item.ListItem.Fields;
using MicrosoftGraph.Workbooks.Item.ListItem.GetActivitiesByInterval;
using MicrosoftGraph.Workbooks.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraph.Workbooks.Item.ListItem.Versions;
using System;
...
namespace MicrosoftGraph.Workbooks.Item.ListItem {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\listItem</summary>
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/listItem{?select,expand}";
