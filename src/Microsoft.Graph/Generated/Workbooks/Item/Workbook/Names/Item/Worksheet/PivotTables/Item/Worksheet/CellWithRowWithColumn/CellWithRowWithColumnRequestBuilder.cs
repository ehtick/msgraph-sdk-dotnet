...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Names.Item.Worksheet.PivotTables.Item.Worksheet.CellWithRowWithColumn {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\names\{workbookNamedItem-id}\worksheet\pivotTables\{workbookPivotTable-id}\worksheet\microsoft.graph.cell(row={row},column={column})</summary>
