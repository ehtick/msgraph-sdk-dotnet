...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Names.Item.Worksheet.CellWithRowWithColumn {
    ...
    public class CellWithRowWithColumnRequestBuilder {
        ...
        public CellWithRowWithColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? row = default, int? column = default) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/names/{workbookNamedItem_id}/worksheet/microsoft.graph.cell(row={row},column={column})";
