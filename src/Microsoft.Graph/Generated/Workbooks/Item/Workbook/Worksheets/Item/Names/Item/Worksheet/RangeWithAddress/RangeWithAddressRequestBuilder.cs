...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Worksheets.Item.Names.Item.Worksheet.RangeWithAddress {
    ...
    public class RangeWithAddressRequestBuilder {
        ...
        public RangeWithAddressRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string address = default) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/names/{workbookNamedItem_id}/worksheet/microsoft.graph.range(address='{address}')";
