...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Worksheets.Item.RangeWithAddress {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\microsoft.graph.range(address='{address}')</summary>
    public class RangeWithAddressRequestBuilder {
        ...
        public RangeWithAddressRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string address = default) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/microsoft.graph.range(address='{address}')";
