...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.ConvertToRange {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\worksheets\{workbookWorksheet-id}\tables\{workbookTable-id}\microsoft.graph.convertToRange</summary>
    public class ConvertToRangeRequestBuilder {
        ...
        public ConvertToRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/worksheets/{workbookWorksheet_id}/tables/{workbookTable_id}/microsoft.graph.convertToRange";
        ...
        public class ConvertToRangeResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as ConvertToRangeResponse).WorkbookRange = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WorkbookRange>(); } },
                };
            }
            /// <summary>
