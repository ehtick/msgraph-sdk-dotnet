...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item.Worksheet.RangeWithAddress {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\pivotTables\{workbookPivotTable-id}\worksheet\microsoft.graph.range(address='{address}')</summary>
    public class RangeWithAddressRequestBuilder {
        ...
        public RangeWithAddressRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string address = default) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/pivotTables/{workbookPivotTable_id}/worksheet/microsoft.graph.range(address='{address}')";
        ...
        public class RangeWithAddressResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as RangeWithAddressResponse).WorkbookRange = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WorkbookRange>(); } },
                };
            }
            /// <summary>
