...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item.Worksheet.UsedRangeWithValuesOnly {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\pivotTables\{workbookPivotTable-id}\worksheet\microsoft.graph.usedRange(valuesOnly={valuesOnly})</summary>
    public class UsedRangeWithValuesOnlyRequestBuilder {
        ...
        public UsedRangeWithValuesOnlyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, bool? valuesOnly = default) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/pivotTables/{workbookPivotTable_id}/worksheet/microsoft.graph.usedRange(valuesOnly={valuesOnly})";
        ...
        public async Task<UsedRangeWithValuesOnlyResponse> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<UsedRangeWithValuesOnlyResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        ...
        public class UsedRangeWithValuesOnlyResponse : IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as UsedRangeWithValuesOnlyResponse).WorkbookRange = n.GetObjectValue<MicrosoftGraph.Models.Microsoft.Graph.WorkbookRange>(); } },
                };
            }
            /// <summary>
