...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Tables.Item.Worksheet.RangeWithAddress {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\microsoft.graph.range(address='{address}')</summary>
    public class RangeWithAddressRequestBuilder {
        ...
        public RangeWithAddressRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string address = default) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/microsoft.graph.range(address='{address}')";
