...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Tables.Item.Worksheet.Tables.Item.Range {
    ...
    public class RangeRequestBuilder {
        ...
        public RangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/tables/{workbookTable_id1}/microsoft.graph.range()";
