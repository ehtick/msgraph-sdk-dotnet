...
namespace MicrosoftGraph.Workbooks.Item.Workbook.Tables.Item.Worksheet.CellWithRowWithColumn {
    /// <summary>Builds and executes requests for operations under \workbooks\{driveItem-id}\workbook\tables\{workbookTable-id}\worksheet\microsoft.graph.cell(row={row},column={column})</summary>
    public class CellWithRowWithColumnRequestBuilder {
        ...
        public CellWithRowWithColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? row = default, int? column = default) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem_id}/workbook/tables/{workbookTable_id}/worksheet/microsoft.graph.cell(row={row},column={column})";
