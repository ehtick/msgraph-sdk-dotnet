...
namespace MicrosoftGraph.DirectoryObjects.GetAvailableExtensionProperties {
    /// <summary>Builds and executes requests for operations under \directoryObjects\microsoft.graph.getAvailableExtensionProperties</summary>
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public GetAvailableExtensionPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directoryObjects/microsoft.graph.getAvailableExtensionProperties";
