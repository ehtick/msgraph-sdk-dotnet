...
using MicrosoftGraph.DirectoryObjects.GetAvailableExtensionProperties;
...
namespace MicrosoftGraph.DirectoryObjects {
    ...
    public class DirectoryObjectsRequestBuilder {
        ...
        /// </summary>
        public DirectoryObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/directoryObjects{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public DirectoryObjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DirectoryObject body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// </summary>
        public async Task<DirectoryObjectsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<DirectoryObjectsResponse>(requestInfo, responseHandler, default, cancellationToken);
        }
        /// <summary>
        /// Add new entity to directoryObjects
        /// <param name="body"></param>
        ...
        /// <summary>Get entities from directoryObjects</summary>
