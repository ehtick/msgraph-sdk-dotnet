...
using MicrosoftGraph.Groups.Item.CalendarView.Item.Accept;
using MicrosoftGraph.Groups.Item.CalendarView.Item.Attachments;
using MicrosoftGraph.Groups.Item.CalendarView.Item.Calendar;
using MicrosoftGraph.Groups.Item.CalendarView.Item.Cancel;
using MicrosoftGraph.Groups.Item.CalendarView.Item.Decline;
using MicrosoftGraph.Groups.Item.CalendarView.Item.DismissReminder;
using MicrosoftGraph.Groups.Item.CalendarView.Item.Extensions;
using MicrosoftGraph.Groups.Item.CalendarView.Item.Forward;
using MicrosoftGraph.Groups.Item.CalendarView.Item.Instances;
using MicrosoftGraph.Groups.Item.CalendarView.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Groups.Item.CalendarView.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Groups.Item.CalendarView.Item.SnoozeReminder;
using MicrosoftGraph.Groups.Item.CalendarView.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Groups.Item.CalendarView.Item {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\calendarView\{event-id}</summary>
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/calendarView/{event_id}{?startDateTime,endDateTime,select}";
