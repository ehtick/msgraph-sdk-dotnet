...
using MicrosoftGraph.Groups.Item.Events.Item.Accept;
using MicrosoftGraph.Groups.Item.Events.Item.Attachments;
using MicrosoftGraph.Groups.Item.Events.Item.Calendar;
using MicrosoftGraph.Groups.Item.Events.Item.Cancel;
using MicrosoftGraph.Groups.Item.Events.Item.Decline;
using MicrosoftGraph.Groups.Item.Events.Item.DismissReminder;
using MicrosoftGraph.Groups.Item.Events.Item.Extensions;
using MicrosoftGraph.Groups.Item.Events.Item.Forward;
using MicrosoftGraph.Groups.Item.Events.Item.Instances;
using MicrosoftGraph.Groups.Item.Events.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Groups.Item.Events.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Groups.Item.Events.Item.SnoozeReminder;
using MicrosoftGraph.Groups.Item.Events.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Groups.Item.Events.Item {
    ...
    public class EventRequestBuilder {
        ...
        public EventRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/events/{event_id}{?select}";
