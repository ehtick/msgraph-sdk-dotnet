...
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Forward;
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Reply;
...
namespace MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.InReplyTo {
    ...
    public class InReplyToRequestBuilder {
        ...
        public InReplyToRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/threads/{conversationThread_id}/posts/{post_id}/inReplyTo{?select,expand}";
