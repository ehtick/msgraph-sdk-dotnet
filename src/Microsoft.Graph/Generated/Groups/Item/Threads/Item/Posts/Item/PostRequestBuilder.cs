...
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.Attachments;
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.Extensions;
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.Forward;
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.InReplyTo;
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.Reply;
using MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties;
...
namespace MicrosoftGraph.Groups.Item.Threads.Item.Posts.Item {
