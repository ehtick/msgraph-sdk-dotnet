...
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.Forward;
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.Reply;
...
namespace MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo {
    /// <summary>Builds and executes requests for operations under \groups\{group-id}\conversations\{conversation-id}\threads\{conversationThread-id}\posts\{post-id}\inReplyTo</summary>
    public class InReplyToRequestBuilder {
        ...
        public InReplyToRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/conversations/{conversation_id}/threads/{conversationThread_id}/posts/{post_id}/inReplyTo{?select,expand}";
