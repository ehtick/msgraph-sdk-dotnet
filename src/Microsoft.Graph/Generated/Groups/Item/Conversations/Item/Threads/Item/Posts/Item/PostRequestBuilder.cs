...
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Attachments;
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Extensions;
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Forward;
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo;
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Reply;
using MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.SingleValueExtendedProperties;
...
namespace MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item {
    ...
    public class PostRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Post body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
