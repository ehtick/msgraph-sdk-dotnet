...
using System.IO;
using System.Linq;
namespace MicrosoftGraph.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.Reply {
    public class ReplyRequestBody : IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"post", (o,n) => { (o as ReplyRequestBody).Post = n.GetObjectValue<Post>(); } },
            };
        }
        /// <summary>
