...
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Accept;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Attachments;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Calendar;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Cancel;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Decline;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.DismissReminder;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Extensions;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Forward;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.Instances;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.MultiValueExtendedProperties;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.SingleValueExtendedProperties;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.SnoozeReminder;
using MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item.TentativelyAccept;
...
namespace MicrosoftGraph.Groups.Item.Calendar.CalendarView.Item {
