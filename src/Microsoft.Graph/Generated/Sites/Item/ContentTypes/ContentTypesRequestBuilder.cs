...
namespace MicrosoftGraph.Sites.Item.ContentTypes {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\contentTypes</summary>
    public class ContentTypesRequestBuilder {
        ...
        public ContentTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/contentTypes{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
