...
using MicrosoftGraph.Sites.Item.TermStores.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStores {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStores</summary>
    public class TermStoresRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.termStores.item collection</summary>
        public StoreRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("store_id", position);
            return new StoreRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public TermStoresRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Store body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
