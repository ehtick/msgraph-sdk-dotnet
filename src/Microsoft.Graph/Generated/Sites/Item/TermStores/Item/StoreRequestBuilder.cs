...
using MicrosoftGraph.Sites.Item.TermStores.Item.Groups;
using MicrosoftGraph.Sites.Item.TermStores.Item.Sets;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStores.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}</summary>
    public class StoreRequestBuilder {
        ...
        public StoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}{?select,expand}";
