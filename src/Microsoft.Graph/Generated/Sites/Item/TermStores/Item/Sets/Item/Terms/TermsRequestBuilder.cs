...
using MicrosoftGraph.Sites.Item.TermStores.Item.Sets.Item.Terms.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStores.Item.Sets.Item.Terms {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\terms</summary>
    public class TermsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.termStores.item.sets.item.terms.item collection</summary>
        ...
        public TermsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/terms{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
