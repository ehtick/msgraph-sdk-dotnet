...
using MicrosoftGraph.Sites.Item.TermStores.Item.Sets.Item.Relations.Item.FromTerm;
using MicrosoftGraph.Sites.Item.TermStores.Item.Sets.Item.Relations.Item.Set;
using MicrosoftGraph.Sites.Item.TermStores.Item.Sets.Item.Relations.Item.ToTerm;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStores.Item.Sets.Item.Relations.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\relations\{relation-id}</summary>
    public class RelationRequestBuilder {
        ...
        public RelationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/relations/{relation_id}{?select,expand}";
