...
using MicrosoftGraph.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Children;
using MicrosoftGraph.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations;
using MicrosoftGraph.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Set;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStores.Item.Sets.Item.Children.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\sets\{set-id}\children\{term-id}</summary>
    public class TermRequestBuilder {
        ...
        public TermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/children/{term_id}{?select,expand}";
