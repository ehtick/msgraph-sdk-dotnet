...
using MicrosoftGraph.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}\sets\{set-id}\children</summary>
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.termStores.item.groups.item.sets.item.children.item collection</summary>
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
