...
using MicrosoftGraph.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Relations.Item.FromTerm.Ref;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Relations.Item.FromTerm {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}\sets\{set-id}\children\{term-id}\relations\{relation-id}\fromTerm</summary>
    public class FromTermRequestBuilder {
        ...
        public FromTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/children/{term_id}/relations/{relation_id}/fromTerm{?select,expand}";
