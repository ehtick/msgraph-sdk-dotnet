...
namespace MicrosoftGraph.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.ParentGroup {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}\sets\{set-id}\parentGroup</summary>
    public class ParentGroupRequestBuilder {
        ...
        public ParentGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/parentGroup{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public ParentGroupRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
