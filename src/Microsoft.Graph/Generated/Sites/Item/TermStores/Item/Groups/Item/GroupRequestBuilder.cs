...
using MicrosoftGraph.Sites.Item.TermStores.Item.Groups.Item.Sets;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStores.Item.Groups.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}</summary>
