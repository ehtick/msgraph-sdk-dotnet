...
namespace MicrosoftGraph.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Terms.Item.Children.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStores\{store-id}\groups\{group-id}\sets\{set-id}\terms\{term-id}\children\{term-id1}</summary>
    public class TermRequestBuilder {
        ...
        public TermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStores/{store_id}/groups/{group_id}/sets/{set_id}/terms/{term_id}/children/{term_id1}{?select,expand}";
