...
namespace MicrosoftGraph.Sites.Item.TermStore.Groups.Item.Sets.Item.ParentGroup {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStore\groups\{group-id}\sets\{set-id}\parentGroup</summary>
    public class ParentGroupRequestBuilder {
        ...
        public ParentGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/parentGroup{?select,expand}";
