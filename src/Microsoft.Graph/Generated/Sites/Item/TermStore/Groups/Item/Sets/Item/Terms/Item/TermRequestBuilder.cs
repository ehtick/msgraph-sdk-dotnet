...
using MicrosoftGraph.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children;
using MicrosoftGraph.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations;
using MicrosoftGraph.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Set;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStore\groups\{group-id}\sets\{set-id}\terms\{term-id}</summary>
    public class TermRequestBuilder {
        ...
        public TermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}{?select,expand}";
