...
using MicrosoftGraph.Sites.Item.TermStore.Groups.Item.Sets;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStore.Groups.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStore\groups\{group-id}</summary>
    public class GroupRequestBuilder {
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/groups/{group_id}{?select,expand}";
