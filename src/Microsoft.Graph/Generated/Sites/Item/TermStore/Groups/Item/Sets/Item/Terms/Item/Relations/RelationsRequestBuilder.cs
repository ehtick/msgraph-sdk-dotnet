...
using MicrosoftGraph.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.termStore.groups.item.sets.item.terms.item.relations.item collection</summary>
        ...
        public RelationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/groups/{group_id}/sets/{set_id}/terms/{term_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
