...
using MicrosoftGraph.Sites.Item.TermStore.Groups.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStore.Groups {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStore\groups</summary>
    public class GroupsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.termStore.groups.item collection</summary>
        ...
        public GroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/groups{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
