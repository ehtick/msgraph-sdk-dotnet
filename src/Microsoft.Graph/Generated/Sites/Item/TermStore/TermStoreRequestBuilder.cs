...
using MicrosoftGraph.Sites.Item.TermStore.Groups;
using MicrosoftGraph.Sites.Item.TermStore.Sets;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStore {
    ...
    public class TermStoreRequestBuilder {
        ...
        /// </summary>
        public TermStoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore{?select,expand}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public TermStoreRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(Store body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
