...
using MicrosoftGraph.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStore.Sets.Item.ParentGroup {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStore\sets\{set-id}\parentGroup</summary>
    public class ParentGroupRequestBuilder {
        ...
        public ParentGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/parentGroup{?select,expand}";
