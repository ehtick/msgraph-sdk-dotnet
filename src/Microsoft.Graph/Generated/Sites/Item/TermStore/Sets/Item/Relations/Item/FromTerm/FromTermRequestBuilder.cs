...
using MicrosoftGraph.Sites.Item.TermStore.Sets.Item.Relations.Item.FromTerm.Ref;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStore.Sets.Item.Relations.Item.FromTerm {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStore\sets\{set-id}\relations\{relation-id}\fromTerm</summary>
    public class FromTermRequestBuilder {
        ...
        public FromTermRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/relations/{relation_id}/fromTerm{?select,expand}";
