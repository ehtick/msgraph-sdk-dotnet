...
using MicrosoftGraph.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.FromTerm;
using MicrosoftGraph.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.Set;
using MicrosoftGraph.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.ToTerm;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStore\sets\{set-id}\children\{term-id}\relations\{relation-id}</summary>
    public class RelationRequestBuilder {
        ...
        public RelationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/children/{term_id}/relations/{relation_id}{?select,expand}";
