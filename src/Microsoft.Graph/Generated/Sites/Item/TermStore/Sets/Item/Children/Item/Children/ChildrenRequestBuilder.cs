...
using MicrosoftGraph.Sites.Item.TermStore.Sets.Item.Children.Item.Children.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStore.Sets.Item.Children.Item.Children {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStore\sets\{set-id}\children\{term-id}\children</summary>
    public class ChildrenRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.termStore.sets.item.children.item.children.item collection</summary>
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/children/{term_id}/children{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
