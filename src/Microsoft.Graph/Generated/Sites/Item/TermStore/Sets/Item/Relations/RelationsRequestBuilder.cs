...
using MicrosoftGraph.Sites.Item.TermStore.Sets.Item.Relations.Item;
using System;
...
namespace MicrosoftGraph.Sites.Item.TermStore.Sets.Item.Relations {
    /// <summary>Builds and executes requests for operations under \sites\{site-id}\termStore\sets\{set-id}\relations</summary>
    public class RelationsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.sites.item.termStore.sets.item.relations.item collection</summary>
        ...
        public RelationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site_id}/termStore/sets/{set_id}/relations{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
