...
using MicrosoftGraph.Sites.Item.Lists.Item.Items.Item.Analytics;
using MicrosoftGraph.Sites.Item.Lists.Item.Items.Item.DriveItem;
using MicrosoftGraph.Sites.Item.Lists.Item.Items.Item.Fields;
using MicrosoftGraph.Sites.Item.Lists.Item.Items.Item.GetActivitiesByInterval;
using MicrosoftGraph.Sites.Item.Lists.Item.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraph.Sites.Item.Lists.Item.Items.Item.Versions;
using System;
...
namespace MicrosoftGraph.Sites.Item.Lists.Item.Items.Item {
