...
using MicrosoftGraph.Solutions.BookingCurrencies.Item;
using System;
...
namespace MicrosoftGraph.Solutions.BookingCurrencies {
    /// <summary>Builds and executes requests for operations under \solutions\bookingCurrencies</summary>
    public class BookingCurrenciesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.solutions.bookingCurrencies.item collection</summary>
        ...
        public BookingCurrenciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/solutions/bookingCurrencies{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public BookingCurrenciesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(BookingCurrency body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
