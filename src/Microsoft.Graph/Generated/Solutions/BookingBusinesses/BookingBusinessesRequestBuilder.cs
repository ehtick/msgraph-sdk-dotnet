...
using MicrosoftGraph.Solutions.BookingBusinesses.Item;
using System;
...
namespace MicrosoftGraph.Solutions.BookingBusinesses {
    /// <summary>Builds and executes requests for operations under \solutions\bookingBusinesses</summary>
    public class BookingBusinessesRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.solutions.bookingBusinesses.item collection</summary>
        ...
        public BookingBusinessesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/solutions/bookingBusinesses{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(BookingBusiness body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
