...
namespace MicrosoftGraph.Solutions.BookingBusinesses.Item.Appointments.Item.Cancel {
    /// <summary>Builds and executes requests for operations under \solutions\bookingBusinesses\{bookingBusiness-id}\appointments\{bookingAppointment-id}\microsoft.graph.cancel</summary>
    public class CancelRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CancelRequestBody body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
