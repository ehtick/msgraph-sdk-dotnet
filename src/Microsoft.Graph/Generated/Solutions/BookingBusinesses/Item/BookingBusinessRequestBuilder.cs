...
using MicrosoftGraph.Solutions.BookingBusinesses.Item.Appointments;
using MicrosoftGraph.Solutions.BookingBusinesses.Item.CalendarView;
using MicrosoftGraph.Solutions.BookingBusinesses.Item.Customers;
using MicrosoftGraph.Solutions.BookingBusinesses.Item.CustomQuestions;
using MicrosoftGraph.Solutions.BookingBusinesses.Item.Publish;
using MicrosoftGraph.Solutions.BookingBusinesses.Item.Services;
using MicrosoftGraph.Solutions.BookingBusinesses.Item.StaffMembers;
using MicrosoftGraph.Solutions.BookingBusinesses.Item.Unpublish;
using System;
...
namespace MicrosoftGraph.Solutions.BookingBusinesses.Item {
    ...
    public class BookingBusinessRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public BookingBusinessRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
