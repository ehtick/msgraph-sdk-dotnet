...
namespace MicrosoftGraph.ServicePrincipals.GetAvailableExtensionProperties {
    /// <summary>Builds and executes requests for operations under \servicePrincipals\microsoft.graph.getAvailableExtensionProperties</summary>
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public GetAvailableExtensionPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/microsoft.graph.getAvailableExtensionProperties";
