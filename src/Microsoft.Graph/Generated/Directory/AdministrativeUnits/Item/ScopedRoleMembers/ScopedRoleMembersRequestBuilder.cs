...
using MicrosoftGraph.Directory.AdministrativeUnits.Item.ScopedRoleMembers.Item;
...
namespace MicrosoftGraph.Directory.AdministrativeUnits.Item.ScopedRoleMembers {
    /// <summary>Builds and executes requests for operations under \directory\administrativeUnits\{administrativeUnit-id}\scopedRoleMembers</summary>
    public class ScopedRoleMembersRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.directory.administrativeUnits.item.scopedRoleMembers.item collection</summary>
        ...
        public ScopedRoleMembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit_id}/scopedRoleMembers{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ScopedRoleMembership body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
