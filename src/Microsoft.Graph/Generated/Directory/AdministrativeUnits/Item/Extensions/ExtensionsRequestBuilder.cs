...
using MicrosoftGraph.Directory.AdministrativeUnits.Item.Extensions.Item;
...
namespace MicrosoftGraph.Directory.AdministrativeUnits.Item.Extensions {
    /// <summary>Builds and executes requests for operations under \directory\administrativeUnits\{administrativeUnit-id}\extensions</summary>
    public class ExtensionsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.directory.administrativeUnits.item.extensions.item collection</summary>
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit_id}/extensions{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
