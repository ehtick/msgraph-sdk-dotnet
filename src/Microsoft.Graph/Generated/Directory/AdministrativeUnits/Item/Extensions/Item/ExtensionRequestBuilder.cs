...
namespace MicrosoftGraph.Directory.AdministrativeUnits.Item.Extensions.Item {
    /// <summary>Builds and executes requests for operations under \directory\administrativeUnits\{administrativeUnit-id}\extensions\{extension-id}</summary>
    public class ExtensionRequestBuilder {
        ...
        public ExtensionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directory/administrativeUnits/{administrativeUnit_id}/extensions/{extension_id}{?select,expand}";
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(Extension body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
