...
using MicrosoftGraph.Directory.AdministrativeUnits.Delta;
using MicrosoftGraph.Directory.AdministrativeUnits.Item;
...
namespace MicrosoftGraph.Directory.AdministrativeUnits {
    ...
    public class AdministrativeUnitsRequestBuilder {
        ...
        /// <summary>Gets an item from the MicrosoftGraph.directory.administrativeUnits.item collection</summary>
        ...
        /// </summary>
        public AdministrativeUnitsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/directory/administrativeUnits{?top,skip,search,filter,count,orderby,select,expand}";
            var urlTplParams = new Dictionary<string, object>(pathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public AdministrativeUnitsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
