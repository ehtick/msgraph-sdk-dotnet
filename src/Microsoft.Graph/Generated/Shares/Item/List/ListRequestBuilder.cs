...
using MicrosoftGraph.Shares.Item.List.Columns;
using MicrosoftGraph.Shares.Item.List.ContentTypes;
using MicrosoftGraph.Shares.Item.List.Drive;
using MicrosoftGraph.Shares.Item.List.Items;
using MicrosoftGraph.Shares.Item.List.Subscriptions;
using System;
...
namespace MicrosoftGraph.Shares.Item.List {
    /// <summary>Builds and executes requests for operations under \shares\{sharedDriveItem-id}\list</summary>
    public class ListRequestBuilder {
        ...
        public ListRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/list{?select,expand}";
