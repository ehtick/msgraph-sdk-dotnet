...
using MicrosoftGraph.Shares.Item.ListItem.Analytics;
using MicrosoftGraph.Shares.Item.ListItem.DriveItem;
using MicrosoftGraph.Shares.Item.ListItem.Fields;
using MicrosoftGraph.Shares.Item.ListItem.GetActivitiesByInterval;
using MicrosoftGraph.Shares.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using MicrosoftGraph.Shares.Item.ListItem.Versions;
using System;
...
namespace MicrosoftGraph.Shares.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/shares/{sharedDriveItem_id}/listItem{?select,expand}";
